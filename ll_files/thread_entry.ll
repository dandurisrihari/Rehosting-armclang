...
define hidden void @z_thread_entry(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) #1 !dbg !404 {
  ...
  call void @llvm.dbg.declare(metadata ptr %8, metadata !419, metadata !DIExpression()), !dbg !420
  %9 = load ptr, ptr %5, align 4, !dbg !421
  %10 = load ptr, ptr %6, align 4, !dbg !422
  %11 = load ptr, ptr %7, align 4, !dbg !423
  %12 = load ptr, ptr %8, align 4, !dbg !424
  call void %9(ptr noundef %10, ptr noundef %11, ptr noundef %12), !dbg !421
  %13 = call ptr @k_current_get() #5, !dbg !425
  call void @k_thread_abort(ptr noundef %13), !dbg !426
  unreachable, !dbg !427
}
...
; Function Attrs: noinline nounwind optnone
define internal void @k_thread_abort(ptr noundef %0) #0 !dbg !428 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
3:                                                ; preds = %1
  call void asm sideeffect "", "~{memory}"() #6, !dbg !436, !srcloc !438
  br label %4, !dbg !439

4:                                                ; preds = %3
  %5 = load ptr, ptr %2, align 4, !dbg !440
  call void @z_impl_k_thread_abort(ptr noundef %5), !dbg !441
  ret void, !dbg !442
}

; Function Attrs: noinline nounwind optnone willreturn memory(none)
define internal ptr @k_current_get() #3 !dbg !443 {
  %1 = call ptr @k_sched_current_thread_query() #5, !dbg !446
  ret ptr %1, !dbg !447
}
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !448 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !453, metadata !DIExpression()), !dbg !454
  %3 = load ptr, ptr %2, align 4, !dbg !455
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !456
...
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !459 {
  ...
  %3 = load ptr, ptr %2, align 4, !dbg !464
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !465
  %5 = load ptr, ptr %4, align 4, !dbg !465
  ret ptr %5, !dbg !466
}

declare void @z_impl_k_thread_abort(ptr noundef) #4

; Function Attrs: noinline nounwind optnone willreturn memory(none)
define internal ptr @k_sched_current_thread_query() #3 !dbg !467 {
  br label %1, !dbg !468

1:                                                ; preds = %0
  call void asm sideeffect "", "~{memory}"() #6, !dbg !469, !srcloc !471
  br label %2, !dbg !472

2:                                                ; preds = %1
  %3 = call ptr @z_impl_k_sched_current_thread_query(), !dbg !473
  ret ptr %3, !dbg !474
}

declare ptr @z_impl_k_sched_current_thread_query() #4
...
attributes #1 = { noinline noreturn nounwind optnone "denormal-fp-math"="preserve-sign,preserve-sign" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+soft-float,+strict-align,+thumb-mode,-aes,-bf16,-cdecp0,-cdecp1,-cdecp2,-cdecp3,-cdecp4,-cdecp5,-cdecp6,-cdecp7,-crc,-crypto,-d32,-dotprod,-dsp,-fce,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-hwdiv,-hwdiv-arm,-i8mm,-lob,-mve,-mve.fp,-neon,-pacbti,-ras,-sb,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" "use-soft-float"="true" }
attributes #2 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) }
attributes #3 = { noinline nounwind optnone willreturn memory(none) "denormal-fp-math"="preserve-sign,preserve-sign" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+soft-float,+strict-align,+thumb-mode,-aes,-bf16,-cdecp0,-cdecp1,-cdecp2,-cdecp3,-cdecp4,-cdecp5,-cdecp6,-cdecp7,-crc,-crypto,-d32,-dotprod,-dsp,-fce,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-hwdiv,-hwdiv-arm,-i8mm,-lob,-mve,-mve.fp,-neon,-pacbti,-ras,-sb,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" "use-soft-float"="true" }
...
!404 = distinct !DISubprogram(name: "z_thread_entry", scope: !405, file: !405, line: 35, type: !406, scopeLine: 37, flags: DIFlagPrototyped | DIFlagNoReturn, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "lib/os/thread_entry.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{null, !408, !87, !87, !87}
!408 = !DIDerivedType(tag: DW_TAG_typedef, name: "k_thread_entry_t", file: !409, line: 46, baseType: !410)
!409 = !DIFile(filename: "include/zephyr/sys/arch_interface.h", directory: "/home/sri/zephyrproject/zephyr")
!410 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !411, size: 32)
!411 = !DISubroutineType(types: !412)
!412 = !{null, !87, !87, !87}
!413 = !DILocalVariable(name: "entry", arg: 1, scope: !404, file: !405, line: 35, type: !408)
!414 = !DILocation(line: 35, column: 68, scope: !404)
!415 = !DILocalVariable(name: "p1", arg: 2, scope: !404, file: !405, line: 36, type: !87)
!416 = !DILocation(line: 36, column: 12, scope: !404)
!417 = !DILocalVariable(name: "p2", arg: 3, scope: !404, file: !405, line: 36, type: !87)
!418 = !DILocation(line: 36, column: 22, scope: !404)
!419 = !DILocalVariable(name: "p3", arg: 4, scope: !404, file: !405, line: 36, type: !87)
!420 = !DILocation(line: 36, column: 32, scope: !404)
!421 = !DILocation(line: 48, column: 2, scope: !404)
!422 = !DILocation(line: 48, column: 8, scope: !404)
!423 = !DILocation(line: 48, column: 12, scope: !404)
!424 = !DILocation(line: 48, column: 16, scope: !404)
!425 = !DILocation(line: 50, column: 17, scope: !404)
!426 = !DILocation(line: 50, column: 2, scope: !404)
!427 = !DILocation(line: 57, column: 2, scope: !404)
!428 = distinct !DISubprogram(name: "k_thread_abort", scope: !429, file: !429, line: 223, type: !430, scopeLine: 224, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!429 = !DIFile(filename: "zephyr/include/generated/syscalls/kernel.h", directory: "/home/sri/zephyrproject/zephyr/build")
!430 = !DISubroutineType(types: !431)
!431 = !{null, !432}
!432 = !DIDerivedType(tag: DW_TAG_typedef, name: "k_tid_t", file: !105, line: 359, baseType: !103)
!433 = !DILocalVariable(name: "thread", arg: 1, scope: !428, file: !429, line: 223, type: !432)
!434 = !DILocation(line: 223, column: 43, scope: !428)
!435 = !DILocation(line: 232, column: 2, scope: !428)
!436 = !DILocation(line: 232, column: 7, scope: !437)
!437 = distinct !DILexicalBlock(scope: !428, file: !429, line: 232, column: 5)
!438 = !{i64 135404}
!439 = !DILocation(line: 232, column: 47, scope: !437)
!440 = !DILocation(line: 233, column: 24, scope: !428)
!441 = !DILocation(line: 233, column: 2, scope: !428)
!442 = !DILocation(line: 234, column: 1, scope: !428)
!443 = distinct !DISubprogram(name: "k_current_get", scope: !199, file: !199, line: 593, type: !444, scopeLine: 594, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!444 = !DISubroutineType(types: !445)
!445 = !{!432}
!446 = !DILocation(line: 601, column: 9, scope: !443)
!447 = !DILocation(line: 601, column: 2, scope: !443)
!448 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !449, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!449 = !DISubroutineType(types: !450)
!450 = !{!451, !452}
!451 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!452 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!453 = !DILocalVariable(name: "list", arg: 1, scope: !448, file: !338, line: 335, type: !452)
!454 = !DILocation(line: 335, column: 55, scope: !448)
!455 = !DILocation(line: 335, column: 92, scope: !448)
!456 = !DILocation(line: 335, column: 71, scope: !448)
!457 = !DILocation(line: 335, column: 98, scope: !448)
!458 = !DILocation(line: 335, column: 63, scope: !448)
!459 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !460, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!460 = !DISubroutineType(types: !461)
!461 = !{!342, !452}
!462 = !DILocalVariable(name: "list", arg: 1, scope: !459, file: !338, line: 255, type: !452)
!463 = !DILocation(line: 255, column: 64, scope: !459)
!464 = !DILocation(line: 257, column: 9, scope: !459)
!465 = !DILocation(line: 257, column: 15, scope: !459)
!466 = !DILocation(line: 257, column: 2, scope: !459)
!467 = distinct !DISubprogram(name: "k_sched_current_thread_query", scope: !429, file: !429, line: 208, type: !444, scopeLine: 209, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!468 = !DILocation(line: 215, column: 2, scope: !467)
!469 = !DILocation(line: 215, column: 7, scope: !470)
!470 = distinct !DILexicalBlock(scope: !467, file: !429, line: 215, column: 5)
!471 = !{i64 135182}
!472 = !DILocation(line: 215, column: 47, scope: !470)
!473 = !DILocation(line: 216, column: 9, scope: !467)
!474 = !DILocation(line: 216, column: 2, scope: !467)
