...
define hidden void @SystemInit() #0 !dbg !50 {
  ret void, !dbg !54
}

; Function Attrs: nounwind optsize
define hidden void @SystemCoreClockUpdate() #0 !dbg !55 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr %1) #3, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %1, metadata !57, metadata !DIExpression()), !dbg !62
  store i32 0, ptr %1, align 4, !dbg !62
  call void @llvm.lifetime.start.p0(i64 4, ptr %2) #3, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %2, metadata !58, metadata !DIExpression()), !dbg !63
  store i32 0, ptr %2, align 4, !dbg !63
  call void @llvm.lifetime.start.p0(i64 4, ptr %3) #3, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %3, metadata !59, metadata !DIExpression()), !dbg !64
  store i32 0, ptr %3, align 4, !dbg !64
  call void @llvm.lifetime.start.p0(i64 4, ptr %4) #3, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %4, metadata !60, metadata !DIExpression()), !dbg !65
...
44:                                               ; preds = %43, %42, %9, %8
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %4) #3, !dbg !128
  call void @llvm.lifetime.end.p0(i64 4, ptr %3) #3, !dbg !128
  call void @llvm.lifetime.end.p0(i64 4, ptr %2) #3, !dbg !128
  call void @llvm.lifetime.end.p0(i64 4, ptr %1) #3, !dbg !128
  ret void, !dbg !128
}
...
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !3, producer: "Component: Arm Compiler for Embedded 6.20 Tool: armclang [5e9ad700]", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, retainedTypes: !4, globals: !28, splitDebugInlining: false, nameTableKind: None)
...
!49 = !{!"Component: Arm Compiler for Embedded 6.20 Tool: armclang [5e9ad700]"}
!50 = distinct !DISubprogram(name: "SystemInit", scope: !31, file: !31, line: 126, type: !51, scopeLine: 127, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !53)
!51 = !DISubroutineType(types: !52)
!52 = !{null}
!53 = !{}
!54 = !DILocation(line: 134, column: 1, scope: !50)
!55 = distinct !DISubprogram(name: "SystemCoreClockUpdate", scope: !31, file: !31, line: 178, type: !51, scopeLine: 179, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !56)
!56 = !{!57, !58, !59, !60}
!57 = !DILocalVariable(name: "tmp", scope: !55, file: !31, line: 180, type: !12)
!58 = !DILocalVariable(name: "pllmull", scope: !55, file: !31, line: 180, type: !12)
!59 = !DILocalVariable(name: "pllsource", scope: !55, file: !31, line: 180, type: !12)
!60 = !DILocalVariable(name: "predivfactor", scope: !55, file: !31, line: 180, type: !12)
!61 = !DILocation(line: 180, column: 3, scope: !55)
!62 = !DILocation(line: 180, column: 12, scope: !55)
!63 = !DILocation(line: 180, column: 21, scope: !55)
!64 = !DILocation(line: 180, column: 34, scope: !55)
!65 = !DILocation(line: 180, column: 49, scope: !55)
!66 = !DILocation(line: 183, column: 75, scope: !55)
!67 = !DILocation(line: 183, column: 80, scope: !55)
!68 = !DILocation(line: 183, column: 7, scope: !55)
!69 = !DILocation(line: 185, column: 11, scope: !55)
!70 = !DILocation(line: 185, column: 3, scope: !55)
!71 = !DILocation(line: 188, column: 23, scope: !72)
!72 = distinct !DILexicalBlock(scope: !55, file: !31, line: 186, column: 3)
...
!121 = !DILocation(line: 233, column: 91, scope: !55)
!122 = !DILocation(line: 233, column: 96, scope: !55)
!123 = !DILocation(line: 233, column: 115, scope: !55)
!124 = !DILocation(line: 233, column: 9, scope: !55)
!125 = !DILocation(line: 233, column: 7, scope: !55)
!126 = !DILocation(line: 235, column: 23, scope: !55)
!127 = !DILocation(line: 235, column: 19, scope: !55)
!128 = !DILocation(line: 236, column: 1, scope: !55)
