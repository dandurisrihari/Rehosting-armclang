...
; Function Attrs: noinline nounwind optnone
define hidden void @z_pm_save_idle_exit() #0 !dbg !404 {
  call void @sys_clock_idle_exit(), !dbg !408
  ret void, !dbg !409
}

declare void @sys_clock_idle_exit() #1

; Function Attrs: noinline nounwind optnone
define hidden void @idle(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 !dbg !410 {
  %4 = alloca i32, align 4
  ...
  %8 = load ptr, ptr %5, align 4, !dbg !419
  %9 = load ptr, ptr %6, align 4, !dbg !420
  %10 = load ptr, ptr %7, align 4, !dbg !421
  br label %11, !dbg !422

11:                                               ; preds = %3, %11
  call void @llvm.dbg.declare(metadata ptr %4, metadata !423, metadata !DIExpression()), !dbg !428
  %12 = call i32 asm sideeffect "mrs $0, PRIMASK;cpsid i", "=r,~{memory}"() #3, !dbg !431, !srcloc !432
  store i32 %12, ptr %4, align 4, !dbg !431
  %13 = load i32, ptr %4, align 4, !dbg !433
  call void @k_cpu_idle(), !dbg !434
  br label %11, !dbg !422, !llvm.loop !435
}
...
; Function Attrs: noinline nounwind optnone
define internal void @k_cpu_idle() #0 !dbg !437 {
  call void @arch_cpu_idle(), !dbg !438
  ret void, !dbg !439
}

; Function Attrs: noinline nounwind optnone
define weak hidden void @arch_spin_relax() #0 !dbg !440 {
  call void asm sideeffect "nop", ""() #3, !dbg !441, !srcloc !445
  ret void, !dbg !446
}
...
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !447 {
  ...
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !455
  %5 = icmp eq ptr %4, null, !dbg !456
  ret i1 %5, !dbg !457
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !458 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !461, metadata !DIExpression()), !dbg !462
  %3 = load ptr, ptr %2, align 4, !dbg !463
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !464
  %5 = load ptr, ptr %4, align 4, !dbg !464
  ret ptr %5, !dbg !465
}

declare void @arch_cpu_idle() #1
...
!404 = distinct !DISubprogram(name: "z_pm_save_idle_exit", scope: !405, file: !405, line: 21, type: !406, scopeLine: 22, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "kernel/idle.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{null}
!408 = !DILocation(line: 32, column: 2, scope: !404)
!409 = !DILocation(line: 34, column: 1, scope: !404)
!410 = distinct !DISubprogram(name: "idle", scope: !405, file: !405, line: 36, type: !411, scopeLine: 37, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!411 = !DISubroutineType(types: !412)
!412 = !{null, !87, !87, !87}
!413 = !DILocalVariable(name: "unused1", arg: 1, scope: !410, file: !405, line: 36, type: !87)
!414 = !DILocation(line: 36, column: 17, scope: !410)
!415 = !DILocalVariable(name: "unused2", arg: 2, scope: !410, file: !405, line: 36, type: !87)
!416 = !DILocation(line: 36, column: 32, scope: !410)
!417 = !DILocalVariable(name: "unused3", arg: 3, scope: !410, file: !405, line: 36, type: !87)
!418 = !DILocation(line: 36, column: 47, scope: !410)
!419 = !DILocation(line: 38, column: 9, scope: !410)
!420 = !DILocation(line: 39, column: 9, scope: !410)
!421 = !DILocation(line: 40, column: 9, scope: !410)
!422 = !DILocation(line: 44, column: 2, scope: !410)
!423 = !DILocalVariable(name: "key", scope: !424, file: !425, line: 44, type: !165)
!424 = distinct !DISubprogram(name: "arch_irq_lock", scope: !425, file: !425, line: 42, type: !426, scopeLine: 43, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!425 = !DIFile(filename: "include/zephyr/arch/arm/asm_inline_gcc.h", directory: "/home/sri/zephyrproject/zephyr")
!426 = !DISubroutineType(types: !427)
!427 = !{!165}
!428 = !DILocation(line: 44, column: 15, scope: !424, inlinedAt: !429)
!429 = distinct !DILocation(line: 65, column: 10, scope: !430)
!430 = distinct !DILexicalBlock(scope: !410, file: !405, line: 44, column: 12)
!431 = !DILocation(line: 48, column: 2, scope: !424, inlinedAt: !429)
!432 = !{i64 66896}
!433 = !DILocation(line: 80, column: 9, scope: !424, inlinedAt: !429)
!434 = !DILocation(line: 89, column: 3, scope: !430)
!435 = distinct !{!435, !422, !436}
!436 = !DILocation(line: 108, column: 2, scope: !410)
!437 = distinct !DISubprogram(name: "k_cpu_idle", scope: !199, file: !199, line: 5840, type: !406, scopeLine: 5841, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!438 = !DILocation(line: 5842, column: 2, scope: !437)
!439 = !DILocation(line: 5843, column: 1, scope: !437)
!440 = distinct !DISubprogram(name: "arch_spin_relax", scope: !405, file: !405, line: 111, type: !406, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!441 = !DILocation(line: 38, column: 2, scope: !442, inlinedAt: !444)
!442 = distinct !DISubprogram(name: "arch_nop", scope: !443, file: !443, line: 36, type: !406, scopeLine: 37, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!443 = !DIFile(filename: "include/zephyr/arch/arm/misc.h", directory: "/home/sri/zephyrproject/zephyr")
!444 = distinct !DILocation(line: 116, column: 2, scope: !440)
!445 = !{i64 65343}
!446 = !DILocation(line: 117, column: 1, scope: !440)
!447 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !448, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!448 = !DISubroutineType(types: !449)
!449 = !{!450, !451}
!450 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!451 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!452 = !DILocalVariable(name: "list", arg: 1, scope: !447, file: !338, line: 335, type: !451)
!453 = !DILocation(line: 335, column: 55, scope: !447)
!454 = !DILocation(line: 335, column: 92, scope: !447)
!455 = !DILocation(line: 335, column: 71, scope: !447)
!456 = !DILocation(line: 335, column: 98, scope: !447)
!457 = !DILocation(line: 335, column: 63, scope: !447)
!458 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !459, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!459 = !DISubroutineType(types: !460)
!460 = !{!342, !451}
!461 = !DILocalVariable(name: "list", arg: 1, scope: !458, file: !338, line: 255, type: !451)
!462 = !DILocation(line: 255, column: 64, scope: !458)
!463 = !DILocation(line: 257, column: 9, scope: !458)
!464 = !DILocation(line: 257, column: 15, scope: !458)
!465 = !DILocation(line: 257, column: 2, scope: !458)
