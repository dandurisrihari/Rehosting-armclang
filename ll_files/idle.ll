; ModuleID = '../bc_files/idle.bc'
source_filename = "/home/sri/zephyrproject/zephyr/kernel/idle.c"
...
define hidden void @z_pm_save_idle_exit() #1 !dbg !416 {
  call void @sys_clock_idle_exit() #5, !dbg !420
  ret void, !dbg !421
}

; Function Attrs: optsize
declare !dbg !422 dso_local void @sys_clock_idle_exit() #2

; Function Attrs: nounwind optsize
define hidden void @idle(ptr noundef %0, ptr noundef %1, ptr noundef %2) #1 !dbg !424 {
  %4 = alloca i32, align 4
  %5 = alloca ptr, align 4
  %6 = alloca ptr, align 4
  %7 = alloca ptr, align 4
  store ptr %0, ptr %5, align 4
  call void @llvm.dbg.declare(metadata ptr %5, metadata !428, metadata !DIExpression()), !dbg !431
  store ptr %1, ptr %6, align 4
  call void @llvm.dbg.declare(metadata ptr %6, metadata !429, metadata !DIExpression()), !dbg !432
  store ptr %2, ptr %7, align 4
  call void @llvm.dbg.declare(metadata ptr %7, metadata !430, metadata !DIExpression()), !dbg !433
  %8 = load ptr, ptr %5, align 4, !dbg !434
  %9 = load ptr, ptr %6, align 4, !dbg !435
  %10 = load ptr, ptr %7, align 4, !dbg !436
  br label %11, !dbg !437

11:                                               ; preds = %3, %11
  call void @llvm.lifetime.start.p0(i64 4, ptr %4) #6, !dbg !438
  call void @llvm.dbg.declare(metadata ptr %4, metadata !444, metadata !DIExpression()), !dbg !447
  %12 = call i32 asm sideeffect "mrs $0, PRIMASK;cpsid i", "=r,~{memory}"() #6, !dbg !448, !srcloc !449
  store i32 %12, ptr %4, align 4, !dbg !448
  %13 = load i32, ptr %4, align 4, !dbg !450
  call void @llvm.lifetime.end.p0(i64 4, ptr %4) #6, !dbg !451
  call void @k_cpu_idle() #5, !dbg !452
  br label %11, !dbg !437, !llvm.loop !453
}
...
; Function Attrs: inlinehint nounwind optsize
define internal void @k_cpu_idle() #0 !dbg !455 {
  call void @arch_cpu_idle() #5, !dbg !456
  ret void, !dbg !457
}

; Function Attrs: nounwind optsize
define weak hidden void @arch_spin_relax() #1 !dbg !458 {
  call void asm sideeffect "nop", ""() #6, !dbg !459, !srcloc !463
  ret void, !dbg !464
}

; Function Attrs: optsize
declare !dbg !465 dso_local i64 @z_timeout_expires(ptr noundef) #2

; Function Attrs: optsize
declare !dbg !470 dso_local i64 @z_timeout_remaining(ptr noundef) #2

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !471 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !477, metadata !DIExpression()), !dbg !478
  %3 = load ptr, ptr %2, align 4, !dbg !479
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #5, !dbg !480
  %5 = icmp eq ptr %4, null, !dbg !481
  ret i1 %5, !dbg !482
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !483 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
; Function Attrs: optsize
declare !dbg !492 dso_local void @arch_cpu_idle() #2
...
!1 = !DIFile(filename: "idle.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "z_pm_save_idle_exit", scope: !417, file: !417, line: 21, type: !418, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!417 = !DIFile(filename: "kernel/idle.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{null}
!420 = !DILocation(line: 32, column: 2, scope: !416)
!421 = !DILocation(line: 34, column: 1, scope: !416)
!422 = !DISubprogram(name: "sys_clock_idle_exit", scope: !423, file: !423, line: 87, type: !418, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!423 = !DIFile(filename: "include/zephyr/drivers/timer/system_timer.h", directory: "/home/sri/zephyrproject/zephyr")
!424 = distinct !DISubprogram(name: "idle", scope: !417, file: !417, line: 36, type: !425, scopeLine: 37, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !427)
!425 = !DISubroutineType(types: !426)
!426 = !{null, !87, !87, !87}
!427 = !{!428, !429, !430}
!428 = !DILocalVariable(name: "unused1", arg: 1, scope: !424, file: !417, line: 36, type: !87)
!429 = !DILocalVariable(name: "unused2", arg: 2, scope: !424, file: !417, line: 36, type: !87)
!430 = !DILocalVariable(name: "unused3", arg: 3, scope: !424, file: !417, line: 36, type: !87)
!431 = !DILocation(line: 36, column: 17, scope: !424)
!432 = !DILocation(line: 36, column: 32, scope: !424)
!433 = !DILocation(line: 36, column: 47, scope: !424)
!434 = !DILocation(line: 38, column: 9, scope: !424)
!435 = !DILocation(line: 39, column: 9, scope: !424)
!436 = !DILocation(line: 40, column: 9, scope: !424)
!437 = !DILocation(line: 44, column: 2, scope: !424)
!438 = !DILocation(line: 44, column: 2, scope: !439, inlinedAt: !445)
!439 = distinct !DISubprogram(name: "arch_irq_lock", scope: !440, file: !440, line: 42, type: !441, scopeLine: 43, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !443)
!440 = !DIFile(filename: "include/zephyr/arch/arm/asm_inline_gcc.h", directory: "/home/sri/zephyrproject/zephyr")
!441 = !DISubroutineType(types: !442)
!442 = !{!163}
!443 = !{!444}
!444 = !DILocalVariable(name: "key", scope: !439, file: !440, line: 44, type: !163)
!445 = distinct !DILocation(line: 65, column: 10, scope: !446)
!446 = distinct !DILexicalBlock(scope: !424, file: !417, line: 44, column: 12)
!447 = !DILocation(line: 44, column: 15, scope: !439, inlinedAt: !445)
!448 = !DILocation(line: 48, column: 2, scope: !439, inlinedAt: !445)
!449 = !{i64 66896}
!450 = !DILocation(line: 80, column: 9, scope: !439, inlinedAt: !445)
!451 = !DILocation(line: 81, column: 1, scope: !439, inlinedAt: !445)
!452 = !DILocation(line: 89, column: 3, scope: !446)
!453 = distinct !{!453, !437, !454}
!454 = !DILocation(line: 108, column: 2, scope: !424)
!455 = distinct !DISubprogram(name: "k_cpu_idle", scope: !197, file: !197, line: 5840, type: !418, scopeLine: 5841, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!456 = !DILocation(line: 5842, column: 2, scope: !455)
!457 = !DILocation(line: 5843, column: 1, scope: !455)
!458 = distinct !DISubprogram(name: "arch_spin_relax", scope: !417, file: !417, line: 111, type: !418, scopeLine: 112, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!459 = !DILocation(line: 38, column: 2, scope: !460, inlinedAt: !462)
!460 = distinct !DISubprogram(name: "arch_nop", scope: !461, file: !461, line: 36, type: !418, scopeLine: 37, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!461 = !DIFile(filename: "include/zephyr/arch/arm/misc.h", directory: "/home/sri/zephyrproject/zephyr")
!462 = distinct !DILocation(line: 116, column: 2, scope: !458)
!463 = !{i64 65343}
!464 = !DILocation(line: 117, column: 1, scope: !458)
!465 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !466, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!466 = !DISubroutineType(types: !467)
!467 = !{!258, !468}
!468 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !469, size: 32)
!469 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!470 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !466, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!471 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !472, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !476)
!472 = !DISubroutineType(types: !473)
!473 = !{!474, !475}
!474 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!475 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!476 = !{!477}
!477 = !DILocalVariable(name: "list", arg: 1, scope: !471, file: !346, line: 335, type: !475)
!478 = !DILocation(line: 335, column: 55, scope: !471)
!479 = !DILocation(line: 335, column: 92, scope: !471)
!480 = !DILocation(line: 335, column: 71, scope: !471)
!481 = !DILocation(line: 335, column: 98, scope: !471)
!482 = !DILocation(line: 335, column: 63, scope: !471)
!483 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !484, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !486)
!484 = !DISubroutineType(types: !485)
!485 = !{!350, !475}
!486 = !{!487}
!487 = !DILocalVariable(name: "list", arg: 1, scope: !483, file: !346, line: 255, type: !475)
!488 = !DILocation(line: 255, column: 64, scope: !483)
!489 = !DILocation(line: 257, column: 9, scope: !483)
!490 = !DILocation(line: 257, column: 15, scope: !483)
!491 = !DILocation(line: 257, column: 2, scope: !483)
!492 = !DISubprogram(name: "arch_cpu_idle", scope: !493, file: !493, line: 183, type: !418, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!493 = !DIFile(filename: "include/zephyr/sys/arch_interface.h", directory: "/home/sri/zephyrproject/zephyr")
