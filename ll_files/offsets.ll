...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @z_impl_device_is_ready(ptr noundef %0) #0 !dbg !404 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !425, metadata !DIExpression()), !dbg !426
  %3 = load ptr, ptr %2, align 4, !dbg !427
  %4 = call zeroext i1 @z_device_is_ready(ptr noundef %3), !dbg !428
  ret i1 %4, !dbg !429
}

; Function Attrs: noinline nounwind optnone
define hidden void @_OffsetAbsSyms() #0 !dbg !430 {
  call void asm sideeffect ".globl\09___cpu_t_current_OFFSET\0A\09.equ\09___cpu_t_current_OFFSET,${0:B}\0A\09.type\09___cpu_t_current_OFFSET,%object", "n"(i32 -9) #3, !dbg !434, !srcloc !435
  call void asm sideeffect ".globl\09___cpu_t_nested_OFFSET\0A\09.equ\09___cpu_t_nested_OFFSET,${0:B}\0A\09.type\09___cpu_t_nested_OFFSET,%object", "n"(i32 -1) #3, !dbg !436, !srcloc !437
  call void asm sideeffect ".globl\09___cpu_t_irq_stack_OFFSET\0A\09.equ\09___cpu_t_irq_stack_OFFSET,${0:B}\0A\09.type\09___cpu_t_irq_stack_OFFSET,%object", "n"(i32 -5) #3, !dbg !438, !srcloc !439
  call void asm sideeffect ".globl\09___cpu_t_arch_OFFSET\0A\09.equ\09___cpu_t_arch_OFFSET,${0:B}\0A\09.type\09___cpu_t_arch_OFFSET,%object", "n"(i32 -18) #3, !dbg !440, !srcloc !441
  call void asm sideeffect ".globl\09___kernel_t_cpus_OFFSET\0A\09.equ\09___kernel_t_cpus_OFFSET,${0:B}\0A\09.type\09___kernel_t_cpus_OFFSET,%object", "n"(i32 -1) #3, !dbg !442, !srcloc !443
  call void asm sideeffect ".globl\09___kernel_t_ready_q_OFFSET\0A\09.equ\09___kernel_t_ready_q_OFFSET,${0:B}\0A\09.type\09___kernel_t_ready_q_OFFSET,%object", "n"(i32 -21) #3, !dbg !444, !srcloc !445
  call void asm sideeffect ".globl\09___ready_q_t_cache_OFFSET\0A\09.equ\09___ready_q_t_cache_OFFSET,${0:B}\0A\09.type\09___ready_q_t_cache_OFFSET,%object", "n"(i32 -1) #3, !dbg !446, !srcloc !447
  call void asm sideeffect ".globl\09___thread_base_t_user_options_OFFSET\0A\09.equ\09___thread_base_t_user_options_OFFSET,${0:B}\0A\09.type\09___thread_base_t_user_options_OFFSET,%object", "n"(i32 -13) #3, !dbg !448, !srcloc !449
  call void asm sideeffect ".globl\09___thread_t_base_OFFSET\0A\09.equ\09___thread_t_base_OFFSET,${0:B}\0A\09.type\09___thread_t_base_OFFSET,%object", "n"(i32 -1) #3, !dbg !450, !srcloc !451
  call void asm sideeffect ".globl\09___thread_t_callee_saved_OFFSET\0A\09.equ\09___thread_t_callee_saved_OFFSET,${0:B}\0A\09.type\09___thread_t_callee_saved_OFFSET,%object", "n"(i32 -49) #3, !dbg !452, !srcloc !453
  call void asm sideeffect ".globl\09___thread_t_arch_OFFSET\0A\09.equ\09___thread_t_arch_OFFSET,${0:B}\0A\09.type\09___thread_t_arch_OFFSET,%object", "n"(i32 -105) #3, !dbg !454, !srcloc !455
  call void asm sideeffect ".globl\09__z_interrupt_stack_SIZEOF\0A\09.equ\09__z_interrupt_stack_SIZEOF,${0:B}\0A\09.type\09__z_interrupt_stack_SIZEOF,%object", "n"(i32 -2049) #3, !dbg !456, !srcloc !457
  call void asm sideeffect ".globl\09_PM_DEVICE_STRUCT_FLAGS_OFFSET\0A\09.equ\09_PM_DEVICE_STRUCT_FLAGS_OFFSET,${0:B}\0A\09.type\09_PM_DEVICE_STRUCT_FLAGS_OFFSET,%object", "n"(i32 -1) #3, !dbg !458, !srcloc !459
  call void asm sideeffect ".globl\09_PM_DEVICE_FLAG_PD\0A\09.equ\09_PM_DEVICE_FLAG_PD,${0:B}\0A\09.type\09_PM_DEVICE_FLAG_PD,%object", "n"(i32 -8) #3, !dbg !460, !srcloc !461
  call void asm sideeffect ".globl\09___thread_arch_t_basepri_OFFSET\0A\09.equ\09___thread_arch_t_basepri_OFFSET,${0:B}\0A\09.type\09___thread_arch_t_basepri_OFFSET,%object", "n"(i32 -1) #3, !dbg !462, !srcloc !465
  call void asm sideeffect ".globl\09___thread_arch_t_swap_return_value_OFFSET\0A\09.equ\09___thread_arch_t_swap_return_value_OFFSET,${0:B}\0A\09.type\09___thread_arch_t_swap_return_value_OFFSET,%object", "n"(i32 -5) #3, !dbg !466, !srcloc !467
  call void asm sideeffect ".globl\09___basic_sf_t_pc_OFFSET\0A\09.equ\09___basic_sf_t_pc_OFFSET,${0:B}\0A\09.type\09___basic_sf_t_pc_OFFSET,%object", "n"(i32 -25) #3, !dbg !468, !srcloc !469
  call void asm sideeffect ".globl\09___basic_sf_t_xpsr_OFFSET\0A\09.equ\09___basic_sf_t_xpsr_OFFSET,${0:B}\0A\09.type\09___basic_sf_t_xpsr_OFFSET,%object", "n"(i32 -29) #3, !dbg !470, !srcloc !471
  call void asm sideeffect ".globl\09___esf_t_SIZEOF\0A\09.equ\09___esf_t_SIZEOF,${0:B}\0A\09.type\09___esf_t_SIZEOF,%object", "n"(i32 -33) #3, !dbg !472, !srcloc !473
  call void asm sideeffect ".globl\09___callee_saved_t_SIZEOF\0A\09.equ\09___callee_saved_t_SIZEOF,${0:B}\0A\09.type\09___callee_saved_t_SIZEOF,%object", "n"(i32 -37) #3, !dbg !474, !srcloc !475
  ret void, !dbg !476
}
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !479 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !483, metadata !DIExpression()), !dbg !484
  %3 = load ptr, ptr %2, align 4, !dbg !485
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !486
  %5 = icmp eq ptr %4, null, !dbg !487
  ret i1 %5, !dbg !488
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !489 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !492, metadata !DIExpression()), !dbg !493
  %3 = load ptr, ptr %2, align 4, !dbg !494
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !495
  %5 = load ptr, ptr %4, align 4, !dbg !495
  ret ptr %5, !dbg !496
}
...
!404 = distinct !DISubprogram(name: "z_impl_device_is_ready", scope: !405, file: !405, line: 744, type: !406, scopeLine: 745, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "include/zephyr/device.h", directory: "/home/sri/zephyrproject/zephyr")
...
!411 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "device", file: !405, line: 381, size: 160, elements: !412)
!412 = !{!413, !416, !417, !418, !424}
!413 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !411, file: !405, line: 383, baseType: !414, size: 32)
!414 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !415, size: 32)
!415 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !384)
!416 = !DIDerivedType(tag: DW_TAG_member, name: "config", scope: !411, file: !405, line: 385, baseType: !101, size: 32, offset: 32)
!417 = !DIDerivedType(tag: DW_TAG_member, name: "api", scope: !411, file: !405, line: 387, baseType: !101, size: 32, offset: 64)
!418 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !411, file: !405, line: 389, baseType: !419, size: 32, offset: 96)
!419 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !420, size: 32)
!420 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "device_state", file: !405, line: 354, size: 16, elements: !421)
!421 = !{!422, !423}
!422 = !DIDerivedType(tag: DW_TAG_member, name: "init_res", scope: !420, file: !405, line: 362, baseType: !147, size: 8)
!423 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !420, file: !405, line: 367, baseType: !408, size: 1, offset: 8, flags: DIFlagBitField, extraData: i64 8)
!424 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !411, file: !405, line: 391, baseType: !87, size: 32, offset: 128)
!425 = !DILocalVariable(name: "dev", arg: 1, scope: !404, file: !405, line: 744, type: !409)
!426 = !DILocation(line: 744, column: 65, scope: !404)
!427 = !DILocation(line: 746, column: 27, scope: !404)
!428 = !DILocation(line: 746, column: 9, scope: !404)
!429 = !DILocation(line: 746, column: 2, scope: !404)
!430 = distinct !DISubprogram(name: "_OffsetAbsSyms", scope: !431, file: !431, line: 26, type: !432, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!431 = !DIFile(filename: "kernel/include/kernel_offsets.h", directory: "/home/sri/zephyrproject/zephyr")
!432 = !DISubroutineType(types: !433)
!433 = !{null}
!434 = !DILocation(line: 28, column: 1, scope: !430)
!435 = !{i64 340190, i64 340230, i64 340276}
!436 = !DILocation(line: 29, column: 1, scope: !430)
!437 = !{i64 340383, i64 340422, i64 340467}
!438 = !DILocation(line: 30, column: 1, scope: !430)
!439 = !{i64 340572, i64 340614, i64 340662}
!440 = !DILocation(line: 31, column: 1, scope: !430)
!441 = !{i64 340773, i64 340810, i64 340853}
!442 = !DILocation(line: 33, column: 1, scope: !430)
!443 = !{i64 340955, i64 340995, i64 341041}
!444 = !DILocation(line: 44, column: 1, scope: !430)
!445 = !{i64 341218, i64 341261, i64 341310}
!446 = !DILocation(line: 48, column: 1, scope: !430)
!447 = !{i64 341426, i64 341468, i64 341516}
!448 = !DILocation(line: 55, column: 1, scope: !430)
!449 = !{i64 341633, i64 341686, i64 341745}
!450 = !DILocation(line: 57, column: 1, scope: !430)
!451 = !{i64 341879, i64 341919, i64 341965}
!452 = !DILocation(line: 58, column: 1, scope: !430)
!453 = !{i64 342072, i64 342120, i64 342174}
!454 = !DILocation(line: 59, column: 1, scope: !430)
!455 = !{i64 342297, i64 342337, i64 342383}
!456 = !DILocation(line: 73, column: 1, scope: !430)
!457 = !{i64 342560, i64 342603, i64 342652}
!458 = !DILocation(line: 88, column: 1, scope: !430)
!459 = !{i64 342826, i64 342873, i64 342926}
!460 = !DILocation(line: 91, column: 1, scope: !430)
!461 = !{i64 343050, i64 343085, i64 343126}
!462 = !DILocation(line: 32, column: 1, scope: !463)
!463 = !DILexicalBlockFile(scope: !430, file: !464, discriminator: 0)
!464 = !DIFile(filename: "arch/arm/core/offsets/offsets_aarch32.c", directory: "/home/sri/zephyrproject/zephyr")
!465 = !{i64 343291, i64 343339, i64 343393}
!466 = !DILocation(line: 33, column: 1, scope: !463)
!467 = !{i64 343516, i64 343574, i64 343638}
!468 = !DILocation(line: 53, column: 1, scope: !463)
!469 = !{i64 343859, i64 343899, i64 343945}
!470 = !DILocation(line: 54, column: 1, scope: !463)
!471 = !{i64 344052, i64 344094, i64 344142}
!472 = !DILocation(line: 62, column: 1, scope: !463)
!473 = !{i64 344260, i64 344292, i64 344330}
!474 = !DILocation(line: 66, column: 1, scope: !463)
!475 = !{i64 344411, i64 344452, i64 344499}
!476 = !DILocation(line: 11, column: 1, scope: !477)
!477 = !DILexicalBlockFile(scope: !430, file: !478, discriminator: 0)
!478 = !DIFile(filename: "arch/arm/core/offsets/offsets.c", directory: "/home/sri/zephyrproject/zephyr")
!479 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !480, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!480 = !DISubroutineType(types: !481)
!481 = !{!408, !482}
!482 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!483 = !DILocalVariable(name: "list", arg: 1, scope: !479, file: !338, line: 335, type: !482)
!484 = !DILocation(line: 335, column: 55, scope: !479)
!485 = !DILocation(line: 335, column: 92, scope: !479)
!486 = !DILocation(line: 335, column: 71, scope: !479)
!487 = !DILocation(line: 335, column: 98, scope: !479)
!488 = !DILocation(line: 335, column: 63, scope: !479)
!489 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !490, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!490 = !DISubroutineType(types: !491)
!491 = !{!342, !482}
!492 = !DILocalVariable(name: "list", arg: 1, scope: !489, file: !338, line: 255, type: !482)
!493 = !DILocation(line: 255, column: 64, scope: !489)
!494 = !DILocation(line: 257, column: 9, scope: !489)
!495 = !DILocation(line: 257, column: 15, scope: !489)
!496 = !DILocation(line: 257, column: 2, scope: !489)
