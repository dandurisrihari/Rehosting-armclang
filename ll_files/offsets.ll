; ModuleID = '../bc_files/offsets.bc'
source_filename = "/home/sri/zephyrproject/zephyr/arch/arm/core/offsets/offsets.c"
...
define internal i64 @z_impl_k_thread_timeout_expires_ticks(ptr noundef %0) #0 !dbg !255 {
  ...
  %6 = call i64 @z_timeout_expires(ptr noundef %5) #4, !dbg !268
  ret i64 %6, !dbg !269
}
...
define internal i64 @z_impl_k_thread_timeout_remaining_ticks(ptr noundef %0) #0 !dbg !270 {
  ...
  %6 = call i64 @z_timeout_remaining(ptr noundef %5) #4, !dbg !277
  ret i64 %6, !dbg !278
}
...
define internal i64 @z_impl_k_timer_expires_ticks(ptr noundef %0) #0 !dbg !279 {
  ...
  %5 = call i64 @z_timeout_expires(ptr noundef %4) #4, !dbg !306
  ret i64 %5, !dbg !307
}
...
define internal i64 @z_impl_k_timer_remaining_ticks(ptr noundef %0) #0 !dbg !308 {
  ...
  %5 = call i64 @z_timeout_remaining(ptr noundef %4) #4, !dbg !314
  ret i64 %5, !dbg !315
}
...
define internal i32 @z_impl_k_queue_is_empty(ptr noundef %0) #0 !dbg !338 {
  ...
  %5 = call zeroext i1 @sys_sflist_is_empty(ptr noundef %4) #4, !dbg !364
...
; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @z_impl_device_is_ready(ptr noundef %0) #0 !dbg !416 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !438, metadata !DIExpression()), !dbg !439
  %3 = load ptr, ptr %2, align 4, !dbg !440
  %4 = call zeroext i1 @z_device_is_ready(ptr noundef %3) #4, !dbg !441
  ret i1 %4, !dbg !442
}

; Function Attrs: nounwind optsize
define hidden void @_OffsetAbsSyms() #1 !dbg !443 {
  call void asm sideeffect ".globl\09___cpu_t_current_OFFSET\0A\09.equ\09___cpu_t_current_OFFSET,${0:B}\0A\09.type\09___cpu_t_current_OFFSET,%object", "n"(i32 -9) #5, !dbg !447, !srcloc !448
  call void asm sideeffect ".globl\09___cpu_t_nested_OFFSET\0A\09.equ\09___cpu_t_nested_OFFSET,${0:B}\0A\09.type\09___cpu_t_nested_OFFSET,%object", "n"(i32 -1) #5, !dbg !449, !srcloc !450
  call void asm sideeffect ".globl\09___cpu_t_irq_stack_OFFSET\0A\09.equ\09___cpu_t_irq_stack_OFFSET,${0:B}\0A\09.type\09___cpu_t_irq_stack_OFFSET,%object", "n"(i32 -5) #5, !dbg !451, !srcloc !452
  call void asm sideeffect ".globl\09___cpu_t_arch_OFFSET\0A\09.equ\09___cpu_t_arch_OFFSET,${0:B}\0A\09.type\09___cpu_t_arch_OFFSET,%object", "n"(i32 -18) #5, !dbg !453, !srcloc !454
  call void asm sideeffect ".globl\09___kernel_t_cpus_OFFSET\0A\09.equ\09___kernel_t_cpus_OFFSET,${0:B}\0A\09.type\09___kernel_t_cpus_OFFSET,%object", "n"(i32 -1) #5, !dbg !455, !srcloc !456
  call void asm sideeffect ".globl\09___kernel_t_ready_q_OFFSET\0A\09.equ\09___kernel_t_ready_q_OFFSET,${0:B}\0A\09.type\09___kernel_t_ready_q_OFFSET,%object", "n"(i32 -21) #5, !dbg !457, !srcloc !458
  call void asm sideeffect ".globl\09___ready_q_t_cache_OFFSET\0A\09.equ\09___ready_q_t_cache_OFFSET,${0:B}\0A\09.type\09___ready_q_t_cache_OFFSET,%object", "n"(i32 -1) #5, !dbg !459, !srcloc !460
  call void asm sideeffect ".globl\09___thread_base_t_user_options_OFFSET\0A\09.equ\09___thread_base_t_user_options_OFFSET,${0:B}\0A\09.type\09___thread_base_t_user_options_OFFSET,%object", "n"(i32 -13) #5, !dbg !461, !srcloc !462
  call void asm sideeffect ".globl\09___thread_t_base_OFFSET\0A\09.equ\09___thread_t_base_OFFSET,${0:B}\0A\09.type\09___thread_t_base_OFFSET,%object", "n"(i32 -1) #5, !dbg !463, !srcloc !464
  call void asm sideeffect ".globl\09___thread_t_callee_saved_OFFSET\0A\09.equ\09___thread_t_callee_saved_OFFSET,${0:B}\0A\09.type\09___thread_t_callee_saved_OFFSET,%object", "n"(i32 -49) #5, !dbg !465, !srcloc !466
  call void asm sideeffect ".globl\09___thread_t_arch_OFFSET\0A\09.equ\09___thread_t_arch_OFFSET,${0:B}\0A\09.type\09___thread_t_arch_OFFSET,%object", "n"(i32 -105) #5, !dbg !467, !srcloc !468
  call void asm sideeffect ".globl\09__z_interrupt_stack_SIZEOF\0A\09.equ\09__z_interrupt_stack_SIZEOF,${0:B}\0A\09.type\09__z_interrupt_stack_SIZEOF,%object", "n"(i32 -2049) #5, !dbg !469, !srcloc !470
  call void asm sideeffect ".globl\09_PM_DEVICE_STRUCT_FLAGS_OFFSET\0A\09.equ\09_PM_DEVICE_STRUCT_FLAGS_OFFSET,${0:B}\0A\09.type\09_PM_DEVICE_STRUCT_FLAGS_OFFSET,%object", "n"(i32 -1) #5, !dbg !471, !srcloc !472
  call void asm sideeffect ".globl\09_PM_DEVICE_FLAG_PD\0A\09.equ\09_PM_DEVICE_FLAG_PD,${0:B}\0A\09.type\09_PM_DEVICE_FLAG_PD,%object", "n"(i32 -8) #5, !dbg !473, !srcloc !474
  call void asm sideeffect ".globl\09___thread_arch_t_basepri_OFFSET\0A\09.equ\09___thread_arch_t_basepri_OFFSET,${0:B}\0A\09.type\09___thread_arch_t_basepri_OFFSET,%object", "n"(i32 -1) #5, !dbg !475, !srcloc !478
  call void asm sideeffect ".globl\09___thread_arch_t_swap_return_value_OFFSET\0A\09.equ\09___thread_arch_t_swap_return_value_OFFSET,${0:B}\0A\09.type\09___thread_arch_t_swap_return_value_OFFSET,%object", "n"(i32 -5) #5, !dbg !479, !srcloc !480
  call void asm sideeffect ".globl\09___basic_sf_t_pc_OFFSET\0A\09.equ\09___basic_sf_t_pc_OFFSET,${0:B}\0A\09.type\09___basic_sf_t_pc_OFFSET,%object", "n"(i32 -25) #5, !dbg !481, !srcloc !482
  call void asm sideeffect ".globl\09___basic_sf_t_xpsr_OFFSET\0A\09.equ\09___basic_sf_t_xpsr_OFFSET,${0:B}\0A\09.type\09___basic_sf_t_xpsr_OFFSET,%object", "n"(i32 -29) #5, !dbg !483, !srcloc !484
  call void asm sideeffect ".globl\09___esf_t_SIZEOF\0A\09.equ\09___esf_t_SIZEOF,${0:B}\0A\09.type\09___esf_t_SIZEOF,%object", "n"(i32 -33) #5, !dbg !485, !srcloc !486
  call void asm sideeffect ".globl\09___callee_saved_t_SIZEOF\0A\09.equ\09___callee_saved_t_SIZEOF,${0:B}\0A\09.type\09___callee_saved_t_SIZEOF,%object", "n"(i32 -37) #5, !dbg !487, !srcloc !488
  ret void, !dbg !489
}
...
declare !dbg !492 dso_local i64 @z_timeout_expires(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !497 dso_local i64 @z_timeout_remaining(ptr noundef) #3

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !498 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !503, metadata !DIExpression()), !dbg !504
  %3 = load ptr, ptr %2, align 4, !dbg !505
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #4, !dbg !506
  %5 = icmp eq ptr %4, null, !dbg !507
  ret i1 %5, !dbg !508
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !509 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !513, metadata !DIExpression()), !dbg !514
  %3 = load ptr, ptr %2, align 4, !dbg !515
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !516
  %5 = load ptr, ptr %4, align 4, !dbg !516
  ret ptr %5, !dbg !517
}

; Function Attrs: optsize
declare !dbg !518 dso_local zeroext i1 @z_device_is_ready(ptr noundef) #3
...
!1 = !DIFile(filename: "offsets.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "z_impl_device_is_ready", scope: !417, file: !417, line: 744, type: !418, scopeLine: 745, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !437)
!417 = !DIFile(filename: "include/zephyr/device.h", directory: "/home/sri/zephyrproject/zephyr")
...
!423 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "device", file: !417, line: 381, size: 160, elements: !424)
!424 = !{!425, !428, !429, !430, !436}
!425 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !423, file: !417, line: 383, baseType: !426, size: 32)
!426 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !427, size: 32)
!427 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !394)
!428 = !DIDerivedType(tag: DW_TAG_member, name: "config", scope: !423, file: !417, line: 385, baseType: !99, size: 32, offset: 32)
!429 = !DIDerivedType(tag: DW_TAG_member, name: "api", scope: !423, file: !417, line: 387, baseType: !99, size: 32, offset: 64)
!430 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !423, file: !417, line: 389, baseType: !431, size: 32, offset: 96)
!431 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !432, size: 32)
!432 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "device_state", file: !417, line: 354, size: 16, elements: !433)
!433 = !{!434, !435}
!434 = !DIDerivedType(tag: DW_TAG_member, name: "init_res", scope: !432, file: !417, line: 362, baseType: !145, size: 8)
!435 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !432, file: !417, line: 367, baseType: !420, size: 1, offset: 8, flags: DIFlagBitField, extraData: i64 8)
!436 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !423, file: !417, line: 391, baseType: !87, size: 32, offset: 128)
!437 = !{!438}
!438 = !DILocalVariable(name: "dev", arg: 1, scope: !416, file: !417, line: 744, type: !421)
!439 = !DILocation(line: 744, column: 65, scope: !416)
!440 = !DILocation(line: 746, column: 27, scope: !416)
!441 = !DILocation(line: 746, column: 9, scope: !416)
!442 = !DILocation(line: 746, column: 2, scope: !416)
!443 = distinct !DISubprogram(name: "_OffsetAbsSyms", scope: !444, file: !444, line: 26, type: !445, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!444 = !DIFile(filename: "kernel/include/kernel_offsets.h", directory: "/home/sri/zephyrproject/zephyr")
!445 = !DISubroutineType(types: !446)
!446 = !{null}
!447 = !DILocation(line: 28, column: 1, scope: !443)
!448 = !{i64 340094, i64 340134, i64 340180}
!449 = !DILocation(line: 29, column: 1, scope: !443)
!450 = !{i64 340287, i64 340326, i64 340371}
!451 = !DILocation(line: 30, column: 1, scope: !443)
!452 = !{i64 340476, i64 340518, i64 340566}
!453 = !DILocation(line: 31, column: 1, scope: !443)
!454 = !{i64 340677, i64 340714, i64 340757}
!455 = !DILocation(line: 33, column: 1, scope: !443)
!456 = !{i64 340859, i64 340899, i64 340945}
!457 = !DILocation(line: 44, column: 1, scope: !443)
!458 = !{i64 341122, i64 341165, i64 341214}
!459 = !DILocation(line: 48, column: 1, scope: !443)
!460 = !{i64 341330, i64 341372, i64 341420}
!461 = !DILocation(line: 55, column: 1, scope: !443)
!462 = !{i64 341537, i64 341590, i64 341649}
!463 = !DILocation(line: 57, column: 1, scope: !443)
!464 = !{i64 341783, i64 341823, i64 341869}
!465 = !DILocation(line: 58, column: 1, scope: !443)
!466 = !{i64 341976, i64 342024, i64 342078}
!467 = !DILocation(line: 59, column: 1, scope: !443)
!468 = !{i64 342201, i64 342241, i64 342287}
!469 = !DILocation(line: 73, column: 1, scope: !443)
!470 = !{i64 342464, i64 342507, i64 342556}
!471 = !DILocation(line: 88, column: 1, scope: !443)
!472 = !{i64 342730, i64 342777, i64 342830}
!473 = !DILocation(line: 91, column: 1, scope: !443)
!474 = !{i64 342954, i64 342989, i64 343030}
!475 = !DILocation(line: 32, column: 1, scope: !476)
!476 = !DILexicalBlockFile(scope: !443, file: !477, discriminator: 0)
!477 = !DIFile(filename: "arch/arm/core/offsets/offsets_aarch32.c", directory: "/home/sri/zephyrproject/zephyr")
!478 = !{i64 343195, i64 343243, i64 343297}
!479 = !DILocation(line: 33, column: 1, scope: !476)
!480 = !{i64 343420, i64 343478, i64 343542}
!481 = !DILocation(line: 53, column: 1, scope: !476)
!482 = !{i64 343763, i64 343803, i64 343849}
!483 = !DILocation(line: 54, column: 1, scope: !476)
!484 = !{i64 343956, i64 343998, i64 344046}
!485 = !DILocation(line: 62, column: 1, scope: !476)
!486 = !{i64 344164, i64 344196, i64 344234}
!487 = !DILocation(line: 66, column: 1, scope: !476)
!488 = !{i64 344315, i64 344356, i64 344403}
!489 = !DILocation(line: 11, column: 1, scope: !490)
!490 = !DILexicalBlockFile(scope: !443, file: !491, discriminator: 0)
!491 = !DIFile(filename: "arch/arm/core/offsets/offsets.c", directory: "/home/sri/zephyrproject/zephyr")
!492 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !493, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!493 = !DISubroutineType(types: !494)
!494 = !{!258, !495}
!495 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !496, size: 32)
!496 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!497 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !493, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!498 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !499, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !502)
!499 = !DISubroutineType(types: !500)
!500 = !{!420, !501}
!501 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!502 = !{!503}
!503 = !DILocalVariable(name: "list", arg: 1, scope: !498, file: !346, line: 335, type: !501)
!504 = !DILocation(line: 335, column: 55, scope: !498)
!505 = !DILocation(line: 335, column: 92, scope: !498)
!506 = !DILocation(line: 335, column: 71, scope: !498)
!507 = !DILocation(line: 335, column: 98, scope: !498)
!508 = !DILocation(line: 335, column: 63, scope: !498)
!509 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !510, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !512)
!510 = !DISubroutineType(types: !511)
!511 = !{!350, !501}
!512 = !{!513}
!513 = !DILocalVariable(name: "list", arg: 1, scope: !509, file: !346, line: 255, type: !501)
!514 = !DILocation(line: 255, column: 64, scope: !509)
!515 = !DILocation(line: 257, column: 9, scope: !509)
!516 = !DILocation(line: 257, column: 15, scope: !509)
!517 = !DILocation(line: 257, column: 2, scope: !509)
!518 = !DISubprogram(name: "z_device_is_ready", scope: !417, file: !417, line: 724, type: !418, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
