; ModuleID = '../bc_files/scb.bc'
source_filename = "/home/sri/zephyrproject/zephyr/arch/arm/core/cortex_m/scb.c"
...
define internal i64 @z_impl_k_thread_timeout_expires_ticks(ptr noundef %0) #0 !dbg !272 {
  ...
  %6 = call i64 @z_timeout_expires(ptr noundef %5) #6, !dbg !285
  ret i64 %6, !dbg !286
}
...
define internal i64 @z_impl_k_thread_timeout_remaining_ticks(ptr noundef %0) #0 !dbg !287 {
  ...
  %6 = call i64 @z_timeout_remaining(ptr noundef %5) #6, !dbg !294
  ret i64 %6, !dbg !295
}
...
define internal i64 @z_impl_k_timer_expires_ticks(ptr noundef %0) #0 !dbg !296 {
  ...
  %5 = call i64 @z_timeout_expires(ptr noundef %4) #6, !dbg !323
  ret i64 %5, !dbg !324
}
...
define internal i64 @z_impl_k_timer_remaining_ticks(ptr noundef %0) #0 !dbg !325 {
  ...
  %5 = call i64 @z_timeout_remaining(ptr noundef %4) #6, !dbg !331
  ret i64 %5, !dbg !332
}
...
define internal i32 @z_impl_k_queue_is_empty(ptr noundef %0) #0 !dbg !355 {
  ...
  %5 = call zeroext i1 @sys_sflist_is_empty(ptr noundef %4) #6, !dbg !381
...
define weak hidden void @sys_arch_reboot(i32 noundef %0) #1 !dbg !433 {
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !438, metadata !DIExpression()), !dbg !439
  %3 = load i32, ptr %2, align 4, !dbg !440
  call void @__NVIC_SystemReset() #7, !dbg !441
  unreachable, !dbg !441
}
...
; Function Attrs: inlinehint noreturn nounwind optsize
define internal void @__NVIC_SystemReset() #3 !dbg !442 {
  call void @llvm.arm.dsb(i32 15), !dbg !445
  store volatile i32 100270084, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 3), align 4, !dbg !446
  call void @llvm.arm.dsb(i32 15), !dbg !447
  br label %1, !dbg !448

1:                                                ; preds = %1, %0
  call void @llvm.arm.hint(i32 0), !dbg !449
  br label %1, !dbg !453, !llvm.loop !454
}

; Function Attrs: optsize
declare !dbg !457 dso_local i64 @z_timeout_expires(ptr noundef) #4

; Function Attrs: optsize
declare !dbg !462 dso_local i64 @z_timeout_remaining(ptr noundef) #4

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !463 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !469, metadata !DIExpression()), !dbg !470
  %3 = load ptr, ptr %2, align 4, !dbg !471
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #6, !dbg !472
  %5 = icmp eq ptr %4, null, !dbg !473
  ret i1 %5, !dbg !474
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !475 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !479, metadata !DIExpression()), !dbg !480
  %3 = load ptr, ptr %2, align 4, !dbg !481
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !482
  %5 = load ptr, ptr %4, align 4, !dbg !482
  ret ptr %5, !dbg !483
}

; Function Attrs: nounwind
declare void @llvm.arm.dsb(i32) #5

; Function Attrs: nounwind
declare void @llvm.arm.hint(i32) #5
...
attributes #3 = { inlinehint noreturn nounwind optsize "denormal-fp-math"="preserve-sign,preserve-sign" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+soft-float,+strict-align,+thumb-mode,-aes,-bf16,-cdecp0,-cdecp1,-cdecp2,-cdecp3,-cdecp4,-cdecp5,-cdecp6,-cdecp7,-crc,-crypto,-d32,-dotprod,-dsp,-fce,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-hwdiv,-hwdiv-arm,-i8mm,-lob,-mve,-mve.fp,-neon,-pacbti,-ras,-sb,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" "use-soft-float"="true" }
...
!1 = !DIFile(filename: "scb.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!90 = !DIDerivedType(tag: DW_TAG_typedef, name: "SCB_Type", file: !91, line: 352, baseType: !92)
!91 = !DIFile(filename: "modules/hal/cmsis/CMSIS/Core/Include/core_cm0.h", directory: "/home/sri/zephyrproject")
!92 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !91, line: 341, size: 320, elements: !93)
!93 = !{!94, !100, !101, !102, !103, !104, !105, !106, !110}
!94 = !DIDerivedType(tag: DW_TAG_member, name: "CPUID", scope: !92, file: !91, line: 343, baseType: !95, size: 32)
!95 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !96)
!96 = !DIDerivedType(tag: DW_TAG_volatile_type, baseType: !97)
!97 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !98, line: 64, baseType: !99)
!98 = !DIFile(filename: "/opt/arm/developmentstudio-2023.0/sw/ARMCompiler6.20/bin/../include/stdint.h", directory: "")
!99 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!100 = !DIDerivedType(tag: DW_TAG_member, name: "ICSR", scope: !92, file: !91, line: 344, baseType: !96, size: 32, offset: 32)
!101 = !DIDerivedType(tag: DW_TAG_member, name: "RESERVED0", scope: !92, file: !91, line: 345, baseType: !97, size: 32, offset: 64)
!102 = !DIDerivedType(tag: DW_TAG_member, name: "AIRCR", scope: !92, file: !91, line: 346, baseType: !96, size: 32, offset: 96)
!103 = !DIDerivedType(tag: DW_TAG_member, name: "SCR", scope: !92, file: !91, line: 347, baseType: !96, size: 32, offset: 128)
!104 = !DIDerivedType(tag: DW_TAG_member, name: "CCR", scope: !92, file: !91, line: 348, baseType: !96, size: 32, offset: 160)
!105 = !DIDerivedType(tag: DW_TAG_member, name: "RESERVED1", scope: !92, file: !91, line: 349, baseType: !97, size: 32, offset: 192)
!106 = !DIDerivedType(tag: DW_TAG_member, name: "SHP", scope: !92, file: !91, line: 350, baseType: !107, size: 64, offset: 224)
!107 = !DICompositeType(tag: DW_TAG_array_type, baseType: !96, size: 64, elements: !108)
!108 = !{!109}
!109 = !DISubrange(count: 2)
!110 = !DIDerivedType(tag: DW_TAG_member, name: "SHCSR", scope: !92, file: !91, line: 351, baseType: !96, size: 32, offset: 288)
...
!154 = !DICompositeType(tag: DW_TAG_array_type, baseType: !155, size: 64, elements: !108)
...
!165 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint8_t", file: !98, line: 62, baseType: !5)
...
!174 = !DIDerivedType(tag: DW_TAG_typedef, name: "int8_t", file: !98, line: 56, baseType: !175)
...
!178 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint16_t", file: !98, line: 63, baseType: !179)
!179 = !DIBasicType(name: "unsigned short", size: 16, encoding: DW_ATE_unsigned)
!180 = !DIDerivedType(tag: DW_TAG_member, name: "order_key", scope: !128, file: !125, line: 108, baseType: !97, size: 32, offset: 128)
!181 = !DIDerivedType(tag: DW_TAG_member, name: "swap_data", scope: !128, file: !125, line: 132, baseType: !87, size: 32, offset: 160)
...
!193 = !DIDerivedType(tag: DW_TAG_typedef, name: "int64_t", file: !98, line: 59, baseType: !194)
...
!199 = !DIDerivedType(tag: DW_TAG_member, name: "v1", scope: !196, file: !197, line: 26, baseType: !97, size: 32)
!200 = !DIDerivedType(tag: DW_TAG_member, name: "v2", scope: !196, file: !197, line: 27, baseType: !97, size: 32, offset: 32)
!201 = !DIDerivedType(tag: DW_TAG_member, name: "v3", scope: !196, file: !197, line: 28, baseType: !97, size: 32, offset: 64)
!202 = !DIDerivedType(tag: DW_TAG_member, name: "v4", scope: !196, file: !197, line: 29, baseType: !97, size: 32, offset: 96)
!203 = !DIDerivedType(tag: DW_TAG_member, name: "v5", scope: !196, file: !197, line: 30, baseType: !97, size: 32, offset: 128)
!204 = !DIDerivedType(tag: DW_TAG_member, name: "v6", scope: !196, file: !197, line: 31, baseType: !97, size: 32, offset: 160)
!205 = !DIDerivedType(tag: DW_TAG_member, name: "v7", scope: !196, file: !197, line: 32, baseType: !97, size: 32, offset: 192)
!206 = !DIDerivedType(tag: DW_TAG_member, name: "v8", scope: !196, file: !197, line: 33, baseType: !97, size: 32, offset: 224)
!207 = !DIDerivedType(tag: DW_TAG_member, name: "psp", scope: !196, file: !197, line: 34, baseType: !97, size: 32, offset: 256)
!208 = !DIDerivedType(tag: DW_TAG_member, name: "init_data", scope: !124, file: !125, line: 258, baseType: !87, size: 32, offset: 672)
!209 = !DIDerivedType(tag: DW_TAG_member, name: "join_queue", scope: !124, file: !125, line: 261, baseType: !158, size: 64, offset: 704)
!210 = !DIDerivedType(tag: DW_TAG_member, name: "errno_var", scope: !124, file: !125, line: 302, baseType: !88, size: 32, offset: 768)
...
!223 = !DIDerivedType(tag: DW_TAG_member, name: "init_mem", scope: !217, file: !218, line: 58, baseType: !87, size: 32, offset: 32)
!224 = !DIDerivedType(tag: DW_TAG_member, name: "init_bytes", scope: !217, file: !218, line: 59, baseType: !225, size: 32, offset: 64)
!225 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !226, line: 46, baseType: !99)
...
!234 = !{!235, !236}
!235 = !DIDerivedType(tag: DW_TAG_member, name: "basepri", scope: !233, file: !197, line: 63, baseType: !97, size: 32)
!236 = !DIDerivedType(tag: DW_TAG_member, name: "swap_return_value", scope: !233, file: !197, line: 66, baseType: !97, size: 32, offset: 32)
!237 = !{!238, !239}
...
!316 = !DIDerivedType(tag: DW_TAG_member, name: "status", scope: !301, file: !214, line: 1460, baseType: !97, size: 32, offset: 384)
!317 = !DIDerivedType(tag: DW_TAG_member, name: "user_data", scope: !301, file: !214, line: 1463, baseType: !87, size: 32, offset: 416)
!318 = !{!319}
...
!338 = !DILocalVariable(name: "user_data", arg: 2, scope: !333, file: !214, line: 1690, type: !87)
...
!372 = !DIDerivedType(tag: DW_TAG_typedef, name: "unative_t", file: !363, line: 40, baseType: !97)
...
!391 = !DIDerivedType(tag: DW_TAG_member, name: "count", scope: !388, file: !214, line: 3094, baseType: !99, size: 32, offset: 64)
!392 = !DIDerivedType(tag: DW_TAG_member, name: "limit", scope: !388, file: !214, line: 3095, baseType: !99, size: 32, offset: 96)
!393 = !{!394}
...
!408 = !DIDerivedType(tag: DW_TAG_member, name: "max_msgs", scope: !403, file: !214, line: 4398, baseType: !97, size: 32, offset: 96)
...
!415 = !DIDerivedType(tag: DW_TAG_member, name: "used_msgs", scope: !403, file: !214, line: 4408, baseType: !97, size: 32, offset: 256)
...
!433 = distinct !DISubprogram(name: "sys_arch_reboot", scope: !434, file: !434, line: 37, type: !435, scopeLine: 38, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !437)
!434 = !DIFile(filename: "arch/arm/core/cortex_m/scb.c", directory: "/home/sri/zephyrproject/zephyr")
!435 = !DISubroutineType(types: !436)
!436 = !{null, !88}
!437 = !{!438}
!438 = !DILocalVariable(name: "type", arg: 1, scope: !433, file: !434, line: 37, type: !88)
!439 = !DILocation(line: 37, column: 52, scope: !433)
!440 = !DILocation(line: 39, column: 9, scope: !433)
!441 = !DILocation(line: 41, column: 2, scope: !433)
!442 = distinct !DISubprogram(name: "__NVIC_SystemReset", scope: !91, file: !91, line: 859, type: !443, scopeLine: 860, flags: DIFlagPrototyped | DIFlagNoReturn | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !231)
!443 = !DISubroutineType(types: !444)
!444 = !{null}
!445 = !DILocation(line: 861, column: 3, scope: !442)
!446 = !DILocation(line: 863, column: 54, scope: !442)
!447 = !DILocation(line: 865, column: 3, scope: !442)
!448 = !DILocation(line: 867, column: 3, scope: !442)
!449 = !DILocation(line: 869, column: 5, scope: !450)
!450 = distinct !DILexicalBlock(scope: !451, file: !91, line: 868, column: 3)
!451 = distinct !DILexicalBlock(scope: !452, file: !91, line: 867, column: 3)
!452 = distinct !DILexicalBlock(scope: !442, file: !91, line: 867, column: 3)
!453 = !DILocation(line: 867, column: 3, scope: !451)
!454 = distinct !{!454, !455, !456}
!455 = !DILocation(line: 867, column: 3, scope: !452)
!456 = !DILocation(line: 870, column: 3, scope: !452)
!457 = !DISubprogram(name: "z_timeout_expires", scope: !214, file: !214, line: 642, type: !458, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !231)
!458 = !DISubroutineType(types: !459)
!459 = !{!275, !460}
!460 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !461, size: 32)
!461 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !183)
!462 = !DISubprogram(name: "z_timeout_remaining", scope: !214, file: !214, line: 643, type: !458, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !231)
!463 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !363, file: !363, line: 335, type: !464, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !468)
!464 = !DISubroutineType(types: !465)
!465 = !{!466, !467}
!466 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!467 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !362, size: 32)
!468 = !{!469}
!469 = !DILocalVariable(name: "list", arg: 1, scope: !463, file: !363, line: 335, type: !467)
!470 = !DILocation(line: 335, column: 55, scope: !463)
!471 = !DILocation(line: 335, column: 92, scope: !463)
!472 = !DILocation(line: 335, column: 71, scope: !463)
!473 = !DILocation(line: 335, column: 98, scope: !463)
!474 = !DILocation(line: 335, column: 63, scope: !463)
!475 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !363, file: !363, line: 255, type: !476, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !478)
!476 = !DISubroutineType(types: !477)
!477 = !{!367, !467}
!478 = !{!479}
!479 = !DILocalVariable(name: "list", arg: 1, scope: !475, file: !363, line: 255, type: !467)
!480 = !DILocation(line: 255, column: 64, scope: !475)
!481 = !DILocation(line: 257, column: 9, scope: !475)
!482 = !DILocation(line: 257, column: 15, scope: !475)
!483 = !DILocation(line: 257, column: 2, scope: !475)
