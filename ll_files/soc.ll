...
@_ram_vector_start = external dso_local global [0 x i8], align 1
...
define internal zeroext i1 @z_impl_device_is_ready(ptr noundef %0) #0 !dbg !81 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !85, metadata !DIExpression()), !dbg !86
  %3 = load ptr, ptr %2, align 4, !dbg !87
  %4 = call zeroext i1 @z_device_is_ready(ptr noundef %3) #6, !dbg !88
  ret i1 %4, !dbg !89
}

; Function Attrs: nounwind optsize
define hidden void @relocate_vector_table() #1 !dbg !90 {
  %1 = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr %1) #7, !dbg !95
  call void @llvm.dbg.declare(metadata ptr %1, metadata !94, metadata !DIExpression()), !dbg !96
  ...
  call void @LL_SYSCFG_SetRemapMemory(i32 noundef 3) #6, !dbg !99
  call void @llvm.lifetime.end.p0(i64 4, ptr %1) #7, !dbg !100
  ret void, !dbg !100
}
...
define internal void @LL_SYSCFG_SetRemapMemory(i32 noundef %0) #0 !dbg !101 {
  ...
  %3 = load volatile i32, ptr inttoptr (i32 1073807360 to ptr), align 4, !dbg !108
  %4 = and i32 %3, -4, !dbg !109
  %5 = load i32, ptr %2, align 4, !dbg !110
  %6 = or i32 %4, %5, !dbg !111
  store volatile i32 %6, ptr inttoptr (i32 1073807360 to ptr), align 4, !dbg !112
  ret void, !dbg !113
}
...
; Function Attrs: nounwind optsize
define internal i32 @stm32f0_init() #1 !dbg !114 {
  store i32 8000000, ptr @SystemCoreClock, align 4, !dbg !116
  ret i32 0, !dbg !117
}

; Function Attrs: optsize
declare !dbg !118 dso_local zeroext i1 @z_device_is_ready(ptr noundef) #5
...
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !3, producer: "Component: Arm Compiler for Embedded 6.20 Tool: armclang [5e9ad700]", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, retainedTypes: !4, globals: !31, splitDebugInlining: false, nameTableKind: None)
...
!80 = !{!"Component: Arm Compiler for Embedded 6.20 Tool: armclang [5e9ad700]"}
!81 = distinct !DISubprogram(name: "z_impl_device_is_ready", scope: !52, file: !52, line: 744, type: !82, scopeLine: 745, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !84)
!82 = !DISubroutineType(types: !83)
!83 = !{!70, !49}
!84 = !{!85}
!85 = !DILocalVariable(name: "dev", arg: 1, scope: !81, file: !52, line: 744, type: !49)
!86 = !DILocation(line: 744, column: 65, scope: !81)
!87 = !DILocation(line: 746, column: 27, scope: !81)
!88 = !DILocation(line: 746, column: 9, scope: !81)
!89 = !DILocation(line: 746, column: 2, scope: !81)
!90 = distinct !DISubprogram(name: "relocate_vector_table", scope: !32, file: !32, line: 46, type: !91, scopeLine: 47, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !93)
!91 = !DISubroutineType(types: !92)
!92 = !{null}
!93 = !{!94}
!94 = !DILocalVariable(name: "vector_size", scope: !90, file: !32, line: 53, type: !5)
!95 = !DILocation(line: 53, column: 2, scope: !90)
!96 = !DILocation(line: 53, column: 9, scope: !90)
!97 = !DILocation(line: 55, column: 43, scope: !90)
!98 = !DILocation(line: 55, column: 2, scope: !90)
!99 = !DILocation(line: 56, column: 2, scope: !90)
!100 = !DILocation(line: 58, column: 1, scope: !90)
!101 = distinct !DISubprogram(name: "LL_SYSCFG_SetRemapMemory", scope: !102, file: !102, line: 348, type: !103, scopeLine: 349, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !105)
...
!104 = !{null, !15}
!105 = !{!106}
!106 = !DILocalVariable(name: "Memory", arg: 1, scope: !101, file: !102, line: 348, type: !15)
!107 = !DILocation(line: 348, column: 56, scope: !101)
!108 = !DILocation(line: 350, column: 126, scope: !101)
!109 = !DILocation(line: 350, column: 135, scope: !101)
!110 = !DILocation(line: 350, column: 162, scope: !101)
!111 = !DILocation(line: 350, column: 159, scope: !101)
!112 = !DILocation(line: 350, column: 66, scope: !101)
!113 = !DILocation(line: 351, column: 1, scope: !101)
!114 = distinct !DISubprogram(name: "stm32f0_init", scope: !32, file: !32, line: 68, type: !42, scopeLine: 69, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !115)
!115 = !{}
!116 = !DILocation(line: 72, column: 18, scope: !114)
!117 = !DILocation(line: 74, column: 2, scope: !114)
!118 = !DISubprogram(name: "z_device_is_ready", scope: !52, file: !52, line: 724, type: !82, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !115)
