...
; Function Attrs: noinline nounwind optnone
define hidden void @z_arm_save_fp_context(ptr noundef %0) #0 !dbg !404 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
; Function Attrs: noinline nounwind optnone
define hidden void @z_arm_restore_fp_context(ptr noundef %0) #0 !dbg !423 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !431 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !435, metadata !DIExpression()), !dbg !436
  %3 = load ptr, ptr %2, align 4, !dbg !437
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !438
  %5 = icmp eq ptr %4, null, !dbg !439
  ret i1 %5, !dbg !440
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !441 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !444, metadata !DIExpression()), !dbg !445
  %3 = load ptr, ptr %2, align 4, !dbg !446
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !447
  %5 = load ptr, ptr %4, align 4, !dbg !447
  ret ptr %5, !dbg !448
}
...
!404 = distinct !DISubprogram(name: "z_arm_save_fp_context", scope: !405, file: !405, line: 17, type: !406, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "arch/arm/core/cortex_m/fpu.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{null, !408}
!408 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !409, size: 32)
!409 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fpu_ctx_full", file: !410, line: 10, size: 1088, elements: !411)
!410 = !DIFile(filename: "include/zephyr/arch/arm/cortex_m/fpu.h", directory: "/home/sri/zephyrproject/zephyr")
!411 = !{!412, !416, !417, !418}
!412 = !DIDerivedType(tag: DW_TAG_member, name: "caller_saved", scope: !409, file: !410, line: 11, baseType: !413, size: 512)
!413 = !DICompositeType(tag: DW_TAG_array_type, baseType: !164, size: 512, elements: !414)
!414 = !{!415}
!415 = !DISubrange(count: 16)
!416 = !DIDerivedType(tag: DW_TAG_member, name: "callee_saved", scope: !409, file: !410, line: 12, baseType: !413, size: 512, offset: 512)
!417 = !DIDerivedType(tag: DW_TAG_member, name: "fpscr", scope: !409, file: !410, line: 13, baseType: !164, size: 32, offset: 1024)
!418 = !DIDerivedType(tag: DW_TAG_member, name: "ctx_saved", scope: !409, file: !410, line: 14, baseType: !419, size: 8, offset: 1056)
!419 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!420 = !DILocalVariable(name: "buffer", arg: 1, scope: !404, file: !405, line: 17, type: !408)
!421 = !DILocation(line: 17, column: 49, scope: !404)
!422 = !DILocation(line: 44, column: 1, scope: !404)
!423 = distinct !DISubprogram(name: "z_arm_restore_fp_context", scope: !405, file: !405, line: 46, type: !424, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!424 = !DISubroutineType(types: !425)
!425 = !{null, !426}
!426 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !427, size: 32)
!427 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !409)
!428 = !DILocalVariable(name: "buffer", arg: 1, scope: !423, file: !405, line: 46, type: !426)
!429 = !DILocation(line: 46, column: 58, scope: !423)
!430 = !DILocation(line: 65, column: 1, scope: !423)
!431 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !432, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!432 = !DISubroutineType(types: !433)
!433 = !{!419, !434}
!434 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!435 = !DILocalVariable(name: "list", arg: 1, scope: !431, file: !338, line: 335, type: !434)
!436 = !DILocation(line: 335, column: 55, scope: !431)
!437 = !DILocation(line: 335, column: 92, scope: !431)
!438 = !DILocation(line: 335, column: 71, scope: !431)
!439 = !DILocation(line: 335, column: 98, scope: !431)
!440 = !DILocation(line: 335, column: 63, scope: !431)
!441 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !442, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!442 = !DISubroutineType(types: !443)
!443 = !{!342, !434}
!444 = !DILocalVariable(name: "list", arg: 1, scope: !441, file: !338, line: 255, type: !434)
!445 = !DILocation(line: 255, column: 64, scope: !441)
!446 = !DILocation(line: 257, column: 9, scope: !441)
!447 = !DILocation(line: 257, column: 15, scope: !441)
!448 = !DILocation(line: 257, column: 2, scope: !441)
