; ModuleID = '../bc_files/fpu.bc'
source_filename = "/home/sri/zephyrproject/zephyr/arch/arm/core/cortex_m/fpu.c"
...
define hidden void @z_arm_save_fp_context(ptr noundef %0) #1 !dbg !416 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
; Function Attrs: nounwind optsize
define hidden void @z_arm_restore_fp_context(ptr noundef %0) #1 !dbg !436 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
declare !dbg !445 dso_local i64 @z_timeout_expires(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !450 dso_local i64 @z_timeout_remaining(ptr noundef) #3

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !451 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !456, metadata !DIExpression()), !dbg !457
  %3 = load ptr, ptr %2, align 4, !dbg !458
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #4, !dbg !459
  %5 = icmp eq ptr %4, null, !dbg !460
  ret i1 %5, !dbg !461
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !462 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
!1 = !DIFile(filename: "fpu.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "z_arm_save_fp_context", scope: !417, file: !417, line: 17, type: !418, scopeLine: 18, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !432)
!417 = !DIFile(filename: "arch/arm/core/cortex_m/fpu.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{null, !420}
!420 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !421, size: 32)
!421 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fpu_ctx_full", file: !422, line: 10, size: 1088, elements: !423)
!422 = !DIFile(filename: "include/zephyr/arch/arm/cortex_m/fpu.h", directory: "/home/sri/zephyrproject/zephyr")
!423 = !{!424, !428, !429, !430}
!424 = !DIDerivedType(tag: DW_TAG_member, name: "caller_saved", scope: !421, file: !422, line: 11, baseType: !425, size: 512)
!425 = !DICompositeType(tag: DW_TAG_array_type, baseType: !162, size: 512, elements: !426)
!426 = !{!427}
!427 = !DISubrange(count: 16)
!428 = !DIDerivedType(tag: DW_TAG_member, name: "callee_saved", scope: !421, file: !422, line: 12, baseType: !425, size: 512, offset: 512)
!429 = !DIDerivedType(tag: DW_TAG_member, name: "fpscr", scope: !421, file: !422, line: 13, baseType: !162, size: 32, offset: 1024)
!430 = !DIDerivedType(tag: DW_TAG_member, name: "ctx_saved", scope: !421, file: !422, line: 14, baseType: !431, size: 8, offset: 1056)
!431 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!432 = !{!433}
!433 = !DILocalVariable(name: "buffer", arg: 1, scope: !416, file: !417, line: 17, type: !420)
!434 = !DILocation(line: 17, column: 49, scope: !416)
!435 = !DILocation(line: 44, column: 1, scope: !416)
!436 = distinct !DISubprogram(name: "z_arm_restore_fp_context", scope: !417, file: !417, line: 46, type: !437, scopeLine: 47, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !441)
!437 = !DISubroutineType(types: !438)
!438 = !{null, !439}
!439 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !440, size: 32)
!440 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !421)
!441 = !{!442}
!442 = !DILocalVariable(name: "buffer", arg: 1, scope: !436, file: !417, line: 46, type: !439)
!443 = !DILocation(line: 46, column: 58, scope: !436)
!444 = !DILocation(line: 65, column: 1, scope: !436)
!445 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !446, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!446 = !DISubroutineType(types: !447)
!447 = !{!258, !448}
!448 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !449, size: 32)
!449 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!450 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !446, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!451 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !452, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !455)
!452 = !DISubroutineType(types: !453)
!453 = !{!431, !454}
!454 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!455 = !{!456}
!456 = !DILocalVariable(name: "list", arg: 1, scope: !451, file: !346, line: 335, type: !454)
!457 = !DILocation(line: 335, column: 55, scope: !451)
!458 = !DILocation(line: 335, column: 92, scope: !451)
!459 = !DILocation(line: 335, column: 71, scope: !451)
!460 = !DILocation(line: 335, column: 98, scope: !451)
!461 = !DILocation(line: 335, column: 63, scope: !451)
!462 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !463, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !465)
!463 = !DISubroutineType(types: !464)
!464 = !{!350, !454}
!465 = !{!466}
!466 = !DILocalVariable(name: "list", arg: 1, scope: !462, file: !346, line: 255, type: !454)
!467 = !DILocation(line: 255, column: 64, scope: !462)
!468 = !DILocation(line: 257, column: 9, scope: !462)
!469 = !DILocation(line: 257, column: 15, scope: !462)
!470 = !DILocation(line: 257, column: 2, scope: !462)
