...
@_k_neg_eagain = external constant i32, align 4
...
; Function Attrs: noinline nounwind optnone
define hidden i32 @arch_swap(i32 noundef %0) #0 !dbg !421 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, ptr %3, align 4
  call void @llvm.dbg.declare(metadata ptr %3, metadata !425, metadata !DIExpression()), !dbg !426
  %4 = load i32, ptr %3, align 4, !dbg !427
  %5 = load ptr, ptr getelementptr inbounds (%struct._cpu, ptr @_kernel, i32 0, i32 2), align 4, !dbg !428
  %6 = getelementptr inbounds %struct.k_thread, ptr %5, i32 0, i32 6, !dbg !429
  %7 = getelementptr inbounds %struct._thread_arch, ptr %6, i32 0, i32 0, !dbg !430
  store i32 %4, ptr %7, align 8, !dbg !431
  %8 = load i32, ptr @_k_neg_eagain, align 4, !dbg !432
  %9 = load ptr, ptr getelementptr inbounds (%struct._cpu, ptr @_kernel, i32 0, i32 2), align 4, !dbg !433
  %10 = getelementptr inbounds %struct.k_thread, ptr %9, i32 0, i32 6, !dbg !434
  %11 = getelementptr inbounds %struct._thread_arch, ptr %10, i32 0, i32 1, !dbg !435
  store i32 %8, ptr %11, align 4, !dbg !436
  %12 = load volatile i32, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 1), align 4, !dbg !437
  %13 = or i32 %12, 268435456, !dbg !437
  store volatile i32 %13, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 1), align 4, !dbg !437
  store i32 0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !438, metadata !DIExpression()), !dbg !443
  %14 = load i32, ptr %2, align 4, !dbg !445
  %15 = icmp ne i32 %14, 0, !dbg !447
  br i1 %15, label %16, label %17, !dbg !448

16:                                               ; preds = %1
  br label %arch_irq_unlock.exit, !dbg !449

17:                                               ; preds = %1
  call void asm sideeffect "cpsie i;isb", "~{memory}"() #3, !dbg !451, !srcloc !452
  br label %arch_irq_unlock.exit, !dbg !453

arch_irq_unlock.exit:                             ; preds = %16, %17
  %18 = load ptr, ptr getelementptr inbounds (%struct._cpu, ptr @_kernel, i32 0, i32 2), align 4, !dbg !454
  %19 = getelementptr inbounds %struct.k_thread, ptr %18, i32 0, i32 6, !dbg !455
  %20 = getelementptr inbounds %struct._thread_arch, ptr %19, i32 0, i32 1, !dbg !456
  %21 = load i32, ptr %20, align 4, !dbg !456
  ret i32 %21, !dbg !457
}
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !458 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !463, metadata !DIExpression()), !dbg !464
  %3 = load ptr, ptr %2, align 4, !dbg !465
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !466
  %5 = icmp eq ptr %4, null, !dbg !467
  ret i1 %5, !dbg !468
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !469 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !472, metadata !DIExpression()), !dbg !473
  %3 = load ptr, ptr %2, align 4, !dbg !474
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !475
  %5 = load ptr, ptr %4, align 4, !dbg !475
  ret ptr %5, !dbg !476
}
...
!421 = distinct !DISubprogram(name: "arch_swap", scope: !422, file: !422, line: 33, type: !423, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !233)
!422 = !DIFile(filename: "arch/arm/core/cortex_m/swap.c", directory: "/home/sri/zephyrproject/zephyr")
!423 = !DISubroutineType(types: !424)
!424 = !{!110, !97}
!425 = !DILocalVariable(name: "key", arg: 1, scope: !421, file: !422, line: 33, type: !97)
!426 = !DILocation(line: 33, column: 28, scope: !421)
!427 = !DILocation(line: 36, column: 42, scope: !421)
!428 = !DILocation(line: 36, column: 18, scope: !421)
!429 = !DILocation(line: 36, column: 27, scope: !421)
!430 = !DILocation(line: 36, column: 32, scope: !421)
!431 = !DILocation(line: 36, column: 40, scope: !421)
!432 = !DILocation(line: 37, column: 52, scope: !421)
!433 = !DILocation(line: 37, column: 18, scope: !421)
!434 = !DILocation(line: 37, column: 27, scope: !421)
!435 = !DILocation(line: 37, column: 32, scope: !421)
!436 = !DILocation(line: 37, column: 50, scope: !421)
!437 = !DILocation(line: 40, column: 52, scope: !421)
!438 = !DILocalVariable(name: "key", arg: 1, scope: !439, file: !440, line: 88, type: !97)
!439 = distinct !DISubprogram(name: "arch_irq_unlock", scope: !440, file: !440, line: 88, type: !441, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !233)
!440 = !DIFile(filename: "include/zephyr/arch/arm/asm_inline_gcc.h", directory: "/home/sri/zephyrproject/zephyr")
!441 = !DISubroutineType(types: !442)
!442 = !{null, !97}
!443 = !DILocation(line: 88, column: 80, scope: !439, inlinedAt: !444)
!444 = distinct !DILocation(line: 43, column: 2, scope: !421)
!445 = !DILocation(line: 91, column: 6, scope: !446, inlinedAt: !444)
!446 = distinct !DILexicalBlock(scope: !439, file: !440, line: 91, column: 6)
!447 = !DILocation(line: 91, column: 10, scope: !446, inlinedAt: !444)
!448 = !DILocation(line: 91, column: 6, scope: !439, inlinedAt: !444)
!449 = !DILocation(line: 92, column: 3, scope: !450, inlinedAt: !444)
!450 = distinct !DILexicalBlock(scope: !446, file: !440, line: 91, column: 17)
!451 = !DILocation(line: 94, column: 2, scope: !439, inlinedAt: !444)
!452 = !{i64 67232}
!453 = !DILocation(line: 114, column: 1, scope: !439, inlinedAt: !444)
!454 = !DILocation(line: 48, column: 25, scope: !421)
!455 = !DILocation(line: 48, column: 34, scope: !421)
!456 = !DILocation(line: 48, column: 39, scope: !421)
!457 = !DILocation(line: 48, column: 2, scope: !421)
!458 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !355, file: !355, line: 335, type: !459, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !233)
!459 = !DISubroutineType(types: !460)
!460 = !{!461, !462}
!461 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!462 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !354, size: 32)
!463 = !DILocalVariable(name: "list", arg: 1, scope: !458, file: !355, line: 335, type: !462)
!464 = !DILocation(line: 335, column: 55, scope: !458)
!465 = !DILocation(line: 335, column: 92, scope: !458)
!466 = !DILocation(line: 335, column: 71, scope: !458)
!467 = !DILocation(line: 335, column: 98, scope: !458)
!468 = !DILocation(line: 335, column: 63, scope: !458)
!469 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !355, file: !355, line: 255, type: !470, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !233)
!470 = !DISubroutineType(types: !471)
!471 = !{!359, !462}
!472 = !DILocalVariable(name: "list", arg: 1, scope: !469, file: !355, line: 255, type: !462)
!473 = !DILocation(line: 255, column: 64, scope: !469)
!474 = !DILocation(line: 257, column: 9, scope: !469)
!475 = !DILocation(line: 257, column: 15, scope: !469)
!476 = !DILocation(line: 257, column: 2, scope: !469)
