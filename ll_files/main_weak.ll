...
define weak hidden i32 @main() #1 !dbg !416 {
  %1 = alloca i32, align 4
  store i32 0, ptr %1, align 4
  call void asm sideeffect "nop", ""() #5, !dbg !420, !srcloc !426
  ret i32 0, !dbg !427
}
...
!416 = distinct !DISubprogram(name: "main", scope: !417, file: !417, line: 24, type: !418, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!417 = !DIFile(filename: "kernel/main_weak.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{!88}
!420 = !DILocation(line: 38, column: 2, scope: !421, inlinedAt: !425)
!421 = distinct !DISubprogram(name: "arch_nop", scope: !422, file: !422, line: 36, type: !423, scopeLine: 37, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!422 = !DIFile(filename: "include/zephyr/arch/arm/misc.h", directory: "/home/sri/zephyrproject/zephyr")
!423 = !DISubroutineType(types: !424)
!424 = !{null}
!425 = distinct !DILocation(line: 27, column: 2, scope: !416)
!426 = !{i64 65547}
!427 = !DILocation(line: 29, column: 2, scope: !416)
!428 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !429, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!429 = !DISubroutineType(types: !430)
!430 = !{!258, !431}
!431 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !432, size: 32)
!432 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!433 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !429, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!434 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !435, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !439)
!435 = !DISubroutineType(types: !436)
!436 = !{!437, !438}
!437 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!438 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!439 = !{!440}
!440 = !DILocalVariable(name: "list", arg: 1, scope: !434, file: !346, line: 335, type: !438)
...
!446 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !447, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !449)
!447 = !DISubroutineType(types: !448)
!448 = !{!350, !438}
!449 = !{!450}
!450 = !DILocalVariable(name: "list", arg: 1, scope: !446, file: !346, line: 255, type: !438)
