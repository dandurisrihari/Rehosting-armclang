; ModuleID = '../bc_files/sys_clock_init.bc'
source_filename = "/home/sri/zephyrproject/zephyr/drivers/timer/sys_clock_init.c"
...
define weak hidden void @sys_clock_set_timeout(i32 noundef %0, i1 noundef zeroext %1) #1 !dbg !416 {
  %3 = alloca i32, align 4
  %4 = alloca i8, align 1
  store i32 %0, ptr %3, align 4
  call void @llvm.dbg.declare(metadata ptr %3, metadata !423, metadata !DIExpression()), !dbg !425
  %5 = zext i1 %1 to i8
  store i8 %5, ptr %4, align 1
  call void @llvm.dbg.declare(metadata ptr %4, metadata !424, metadata !DIExpression()), !dbg !426
  ret void, !dbg !427
}
...
; Function Attrs: nounwind optsize
define weak hidden void @sys_clock_idle_exit() #1 !dbg !428 {
  ret void, !dbg !431
}

; Function Attrs: optsize
declare !dbg !432 dso_local i64 @z_timeout_expires(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !437 dso_local i64 @z_timeout_remaining(ptr noundef) #3

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !438 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !443, metadata !DIExpression()), !dbg !444
  %3 = load ptr, ptr %2, align 4, !dbg !445
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #4, !dbg !446
  %5 = icmp eq ptr %4, null, !dbg !447
  ret i1 %5, !dbg !448
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !449 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !453, metadata !DIExpression()), !dbg !454
  %3 = load ptr, ptr %2, align 4, !dbg !455
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !456
  %5 = load ptr, ptr %4, align 4, !dbg !456
  ret ptr %5, !dbg !457
}
...
!1 = !DIFile(filename: "sys_clock_init.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "sys_clock_set_timeout", scope: !417, file: !417, line: 21, type: !418, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !422)
!417 = !DIFile(filename: "drivers/timer/sys_clock_init.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{null, !420, !421}
!420 = !DIDerivedType(tag: DW_TAG_typedef, name: "int32_t", file: !146, line: 58, baseType: !88)
!421 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!422 = !{!423, !424}
!423 = !DILocalVariable(name: "ticks", arg: 1, scope: !416, file: !417, line: 21, type: !420)
!424 = !DILocalVariable(name: "idle", arg: 2, scope: !416, file: !417, line: 21, type: !421)
!425 = !DILocation(line: 21, column: 62, scope: !416)
!426 = !DILocation(line: 21, column: 75, scope: !416)
!427 = !DILocation(line: 23, column: 1, scope: !416)
!428 = distinct !DISubprogram(name: "sys_clock_idle_exit", scope: !417, file: !417, line: 25, type: !429, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!429 = !DISubroutineType(types: !430)
!430 = !{null}
!431 = !DILocation(line: 27, column: 1, scope: !428)
!432 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !433, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!433 = !DISubroutineType(types: !434)
!434 = !{!258, !435}
!435 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !436, size: 32)
!436 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!437 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !433, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!438 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !439, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !442)
!439 = !DISubroutineType(types: !440)
!440 = !{!421, !441}
!441 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!442 = !{!443}
!443 = !DILocalVariable(name: "list", arg: 1, scope: !438, file: !346, line: 335, type: !441)
!444 = !DILocation(line: 335, column: 55, scope: !438)
!445 = !DILocation(line: 335, column: 92, scope: !438)
!446 = !DILocation(line: 335, column: 71, scope: !438)
!447 = !DILocation(line: 335, column: 98, scope: !438)
!448 = !DILocation(line: 335, column: 63, scope: !438)
!449 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !450, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !452)
!450 = !DISubroutineType(types: !451)
!451 = !{!350, !441}
!452 = !{!453}
!453 = !DILocalVariable(name: "list", arg: 1, scope: !449, file: !346, line: 255, type: !441)
!454 = !DILocation(line: 255, column: 64, scope: !449)
!455 = !DILocation(line: 257, column: 9, scope: !449)
!456 = !DILocation(line: 257, column: 15, scope: !449)
!457 = !DILocation(line: 257, column: 2, scope: !449)
