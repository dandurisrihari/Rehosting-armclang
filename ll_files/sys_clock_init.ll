...
; Function Attrs: noinline nounwind optnone
define weak hidden void @sys_clock_set_timeout(i32 noundef %0, i1 noundef zeroext %1) #0 !dbg !404 {
...
; Function Attrs: noinline nounwind optnone
define weak hidden void @sys_clock_idle_exit() #0 !dbg !415 {
  ret void, !dbg !418
}
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !419 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !423, metadata !DIExpression()), !dbg !424
  %3 = load ptr, ptr %2, align 4, !dbg !425
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !426
  %5 = icmp eq ptr %4, null, !dbg !427
  ret i1 %5, !dbg !428
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !429 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !432, metadata !DIExpression()), !dbg !433
  %3 = load ptr, ptr %2, align 4, !dbg !434
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !435
  %5 = load ptr, ptr %4, align 4, !dbg !435
  ret ptr %5, !dbg !436
}
...
!404 = distinct !DISubprogram(name: "sys_clock_set_timeout", scope: !405, file: !405, line: 21, type: !406, scopeLine: 22, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "drivers/timer/sys_clock_init.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{null, !408, !409}
!408 = !DIDerivedType(tag: DW_TAG_typedef, name: "int32_t", file: !148, line: 58, baseType: !88)
!409 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!410 = !DILocalVariable(name: "ticks", arg: 1, scope: !404, file: !405, line: 21, type: !408)
!411 = !DILocation(line: 21, column: 62, scope: !404)
!412 = !DILocalVariable(name: "idle", arg: 2, scope: !404, file: !405, line: 21, type: !409)
!413 = !DILocation(line: 21, column: 75, scope: !404)
!414 = !DILocation(line: 23, column: 1, scope: !404)
!415 = distinct !DISubprogram(name: "sys_clock_idle_exit", scope: !405, file: !405, line: 25, type: !416, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!416 = !DISubroutineType(types: !417)
!417 = !{null}
!418 = !DILocation(line: 27, column: 1, scope: !415)
!419 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !420, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!420 = !DISubroutineType(types: !421)
!421 = !{!409, !422}
!422 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!423 = !DILocalVariable(name: "list", arg: 1, scope: !419, file: !338, line: 335, type: !422)
!424 = !DILocation(line: 335, column: 55, scope: !419)
!425 = !DILocation(line: 335, column: 92, scope: !419)
!426 = !DILocation(line: 335, column: 71, scope: !419)
!427 = !DILocation(line: 335, column: 98, scope: !419)
!428 = !DILocation(line: 335, column: 63, scope: !419)
!429 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !430, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!430 = !DISubroutineType(types: !431)
!431 = !{!342, !422}
!432 = !DILocalVariable(name: "list", arg: 1, scope: !429, file: !338, line: 255, type: !422)
!433 = !DILocation(line: 255, column: 64, scope: !429)
!434 = !DILocation(line: 257, column: 9, scope: !429)
!435 = !DILocation(line: 257, column: 15, scope: !429)
!436 = !DILocation(line: 257, column: 2, scope: !429)
