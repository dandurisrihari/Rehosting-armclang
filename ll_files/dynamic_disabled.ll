; ModuleID = '../bc_files/dynamic_disabled.bc'
source_filename = "/home/sri/zephyrproject/zephyr/kernel/dynamic_disabled.c"
...
define hidden ptr @z_impl_k_thread_stack_alloc(i32 noundef %0, i32 noundef %1) #1 !dbg !416 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, ptr %3, align 4
  call void @llvm.dbg.declare(metadata ptr %3, metadata !428, metadata !DIExpression()), !dbg !430
  store i32 %1, ptr %4, align 4
  call void @llvm.dbg.declare(metadata ptr %4, metadata !429, metadata !DIExpression()), !dbg !431
  %5 = load i32, ptr %3, align 4, !dbg !432
  %6 = load i32, ptr %4, align 4, !dbg !433
...
; Function Attrs: nounwind optsize
define hidden i32 @z_impl_k_thread_stack_free(ptr noundef %0) #1 !dbg !435 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
declare !dbg !443 dso_local i64 @z_timeout_expires(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !448 dso_local i64 @z_timeout_remaining(ptr noundef) #3

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !449 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !455, metadata !DIExpression()), !dbg !456
  %3 = load ptr, ptr %2, align 4, !dbg !457
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #4, !dbg !458
  %5 = icmp eq ptr %4, null, !dbg !459
  ret i1 %5, !dbg !460
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !461 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !465, metadata !DIExpression()), !dbg !466
  %3 = load ptr, ptr %2, align 4, !dbg !467
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !468
  %5 = load ptr, ptr %4, align 4, !dbg !468
  ret ptr %5, !dbg !469
}
...
!1 = !DIFile(filename: "dynamic_disabled.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "z_impl_k_thread_stack_alloc", scope: !417, file: !417, line: 12, type: !418, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !427)
!417 = !DIFile(filename: "kernel/dynamic_disabled.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{!420, !208, !88}
!420 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !421, size: 32)
!421 = !DIDerivedType(tag: DW_TAG_typedef, name: "k_thread_stack_t", file: !422, line: 44, baseType: !423)
!422 = !DIFile(filename: "include/zephyr/sys/arch_interface.h", directory: "/home/sri/zephyrproject/zephyr")
!423 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "z_thread_stack_element", file: !424, line: 47, size: 8, elements: !425)
!424 = !DIFile(filename: "include/zephyr/kernel/thread_stack.h", directory: "/home/sri/zephyrproject/zephyr")
!425 = !{!426}
!426 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !423, file: !424, line: 48, baseType: !394, size: 8)
!427 = !{!428, !429}
!428 = !DILocalVariable(name: "size", arg: 1, scope: !416, file: !417, line: 12, type: !208)
!429 = !DILocalVariable(name: "flags", arg: 2, scope: !416, file: !417, line: 12, type: !88)
!430 = !DILocation(line: 12, column: 54, scope: !416)
!431 = !DILocation(line: 12, column: 64, scope: !416)
!432 = !DILocation(line: 14, column: 9, scope: !416)
!433 = !DILocation(line: 15, column: 9, scope: !416)
!434 = !DILocation(line: 17, column: 2, scope: !416)
!435 = distinct !DISubprogram(name: "z_impl_k_thread_stack_free", scope: !417, file: !417, line: 20, type: !436, scopeLine: 21, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !438)
!436 = !DISubroutineType(types: !437)
!437 = !{!88, !420}
!438 = !{!439}
!439 = !DILocalVariable(name: "stack", arg: 1, scope: !435, file: !417, line: 20, type: !420)
!440 = !DILocation(line: 20, column: 50, scope: !435)
!441 = !DILocation(line: 22, column: 9, scope: !435)
!442 = !DILocation(line: 24, column: 2, scope: !435)
!443 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !444, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!444 = !DISubroutineType(types: !445)
!445 = !{!258, !446}
!446 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !447, size: 32)
!447 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!448 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !444, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!449 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !450, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !454)
!450 = !DISubroutineType(types: !451)
!451 = !{!452, !453}
!452 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!453 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!454 = !{!455}
!455 = !DILocalVariable(name: "list", arg: 1, scope: !449, file: !346, line: 335, type: !453)
!456 = !DILocation(line: 335, column: 55, scope: !449)
!457 = !DILocation(line: 335, column: 92, scope: !449)
!458 = !DILocation(line: 335, column: 71, scope: !449)
!459 = !DILocation(line: 335, column: 98, scope: !449)
!460 = !DILocation(line: 335, column: 63, scope: !449)
!461 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !462, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !464)
!462 = !DISubroutineType(types: !463)
!463 = !{!350, !453}
!464 = !{!465}
!465 = !DILocalVariable(name: "list", arg: 1, scope: !461, file: !346, line: 255, type: !453)
!466 = !DILocation(line: 255, column: 64, scope: !461)
!467 = !DILocation(line: 257, column: 9, scope: !461)
!468 = !DILocation(line: 257, column: 15, scope: !461)
!469 = !DILocation(line: 257, column: 2, scope: !461)
