...
; Function Attrs: noinline nounwind optnone
define hidden ptr @z_impl_k_thread_stack_alloc(i32 noundef %0, i32 noundef %1) #0 !dbg !404 {
  ...
  %5 = load i32, ptr %3, align 4, !dbg !419
  %6 = load i32, ptr %4, align 4, !dbg !420
  ret ptr null, !dbg !421
}
...
; Function Attrs: noinline nounwind optnone
define hidden i32 @z_impl_k_thread_stack_free(ptr noundef %0) #0 !dbg !422 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !429 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !434, metadata !DIExpression()), !dbg !435
  %3 = load ptr, ptr %2, align 4, !dbg !436
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !437
  %5 = icmp eq ptr %4, null, !dbg !438
  ret i1 %5, !dbg !439
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !440 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !443, metadata !DIExpression()), !dbg !444
  %3 = load ptr, ptr %2, align 4, !dbg !445
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !446
  %5 = load ptr, ptr %4, align 4, !dbg !446
  ret ptr %5, !dbg !447
}
...
!404 = distinct !DISubprogram(name: "z_impl_k_thread_stack_alloc", scope: !405, file: !405, line: 12, type: !406, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "kernel/dynamic_disabled.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{!408, !210, !88}
!408 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !409, size: 32)
!409 = !DIDerivedType(tag: DW_TAG_typedef, name: "k_thread_stack_t", file: !410, line: 44, baseType: !411)
!410 = !DIFile(filename: "include/zephyr/sys/arch_interface.h", directory: "/home/sri/zephyrproject/zephyr")
!411 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "z_thread_stack_element", file: !412, line: 47, size: 8, elements: !413)
!412 = !DIFile(filename: "include/zephyr/kernel/thread_stack.h", directory: "/home/sri/zephyrproject/zephyr")
!413 = !{!414}
!414 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !411, file: !412, line: 48, baseType: !384, size: 8)
!415 = !DILocalVariable(name: "size", arg: 1, scope: !404, file: !405, line: 12, type: !210)
!416 = !DILocation(line: 12, column: 54, scope: !404)
!417 = !DILocalVariable(name: "flags", arg: 2, scope: !404, file: !405, line: 12, type: !88)
!418 = !DILocation(line: 12, column: 64, scope: !404)
!419 = !DILocation(line: 14, column: 9, scope: !404)
!420 = !DILocation(line: 15, column: 9, scope: !404)
!421 = !DILocation(line: 17, column: 2, scope: !404)
!422 = distinct !DISubprogram(name: "z_impl_k_thread_stack_free", scope: !405, file: !405, line: 20, type: !423, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!423 = !DISubroutineType(types: !424)
!424 = !{!88, !408}
!425 = !DILocalVariable(name: "stack", arg: 1, scope: !422, file: !405, line: 20, type: !408)
!426 = !DILocation(line: 20, column: 50, scope: !422)
!427 = !DILocation(line: 22, column: 9, scope: !422)
!428 = !DILocation(line: 24, column: 2, scope: !422)
!429 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !430, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!430 = !DISubroutineType(types: !431)
!431 = !{!432, !433}
!432 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!433 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!434 = !DILocalVariable(name: "list", arg: 1, scope: !429, file: !338, line: 335, type: !433)
!435 = !DILocation(line: 335, column: 55, scope: !429)
!436 = !DILocation(line: 335, column: 92, scope: !429)
!437 = !DILocation(line: 335, column: 71, scope: !429)
!438 = !DILocation(line: 335, column: 98, scope: !429)
!439 = !DILocation(line: 335, column: 63, scope: !429)
!440 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !441, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!441 = !DISubroutineType(types: !442)
!442 = !{!342, !433}
!443 = !DILocalVariable(name: "list", arg: 1, scope: !440, file: !338, line: 255, type: !433)
!444 = !DILocation(line: 255, column: 64, scope: !440)
!445 = !DILocation(line: 257, column: 9, scope: !440)
!446 = !DILocation(line: 257, column: 15, scope: !440)
!447 = !DILocation(line: 257, column: 2, scope: !440)
