; ModuleID = '../bc_files/nmi.bc'
source_filename = "/home/sri/zephyrproject/zephyr/arch/arm/core/nmi.c"
...
define hidden void @z_arm_nmi() #1 !dbg !416 {
  call void @z_SysNmiOnReset() #4, !dbg !420
  call void @z_arm_int_exit() #4, !dbg !421
  ret void, !dbg !422
}

; Function Attrs: optsize
declare !dbg !423 dso_local void @z_SysNmiOnReset() #2

; Function Attrs: optsize
declare !dbg !424 dso_local void @z_arm_int_exit() #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare void @llvm.dbg.declare(metadata, metadata, metadata) #3

; Function Attrs: optsize
declare !dbg !426 dso_local i64 @z_timeout_expires(ptr noundef) #2

; Function Attrs: optsize
declare !dbg !431 dso_local i64 @z_timeout_remaining(ptr noundef) #2

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !432 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !438, metadata !DIExpression()), !dbg !439
  %3 = load ptr, ptr %2, align 4, !dbg !440
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #4, !dbg !441
  %5 = icmp eq ptr %4, null, !dbg !442
  ret i1 %5, !dbg !443
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !444 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !448, metadata !DIExpression()), !dbg !449
  %3 = load ptr, ptr %2, align 4, !dbg !450
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !451
...
!1 = !DIFile(filename: "nmi.c", directory: "/home/sri/zephyrproject/zephyr/build")
!2 = !{!3}
...
!416 = distinct !DISubprogram(name: "z_arm_nmi", scope: !417, file: !417, line: 56, type: !418, scopeLine: 57, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!417 = !DIFile(filename: "arch/arm/core/nmi.c", directory: "/home/sri/zephyrproject/zephyr")
!418 = !DISubroutineType(types: !419)
!419 = !{null}
!420 = !DILocation(line: 58, column: 2, scope: !416)
!421 = !DILocation(line: 59, column: 2, scope: !416)
!422 = !DILocation(line: 60, column: 1, scope: !416)
!423 = !DISubprogram(name: "z_SysNmiOnReset", scope: !417, file: !417, line: 23, type: !418, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!424 = !DISubprogram(name: "z_arm_int_exit", scope: !425, file: !425, line: 153, type: !418, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!425 = !DIFile(filename: "include/zephyr/arch/arm/irq.h", directory: "/home/sri/zephyrproject/zephyr")
!426 = !DISubprogram(name: "z_timeout_expires", scope: !197, file: !197, line: 642, type: !427, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!427 = !DISubroutineType(types: !428)
!428 = !{!258, !429}
!429 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !430, size: 32)
!430 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !166)
!431 = !DISubprogram(name: "z_timeout_remaining", scope: !197, file: !197, line: 643, type: !427, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !214)
!432 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !346, file: !346, line: 335, type: !433, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !437)
!433 = !DISubroutineType(types: !434)
!434 = !{!435, !436}
!435 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!436 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !345, size: 32)
!437 = !{!438}
!438 = !DILocalVariable(name: "list", arg: 1, scope: !432, file: !346, line: 335, type: !436)
!439 = !DILocation(line: 335, column: 55, scope: !432)
!440 = !DILocation(line: 335, column: 92, scope: !432)
!441 = !DILocation(line: 335, column: 71, scope: !432)
!442 = !DILocation(line: 335, column: 98, scope: !432)
!443 = !DILocation(line: 335, column: 63, scope: !432)
!444 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !346, file: !346, line: 255, type: !445, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !447)
!445 = !DISubroutineType(types: !446)
!446 = !{!350, !436}
!447 = !{!448}
!448 = !DILocalVariable(name: "list", arg: 1, scope: !444, file: !346, line: 255, type: !436)
!449 = !DILocation(line: 255, column: 64, scope: !444)
!450 = !DILocation(line: 257, column: 9, scope: !444)
!451 = !DILocation(line: 257, column: 15, scope: !444)
!452 = !DILocation(line: 257, column: 2, scope: !444)
