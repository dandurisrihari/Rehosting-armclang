...
; Function Attrs: noinline nounwind optnone
define hidden void @z_arm_nmi() #0 !dbg !404 {
  call void @z_SysNmiOnReset(), !dbg !408
  call void @z_arm_int_exit(), !dbg !409
  ret void, !dbg !410
}

declare void @z_SysNmiOnReset() #1

declare void @z_arm_int_exit() #1
...
; Function Attrs: noinline nounwind optnone
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !411 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !416, metadata !DIExpression()), !dbg !417
  %3 = load ptr, ptr %2, align 4, !dbg !418
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3), !dbg !419
  %5 = icmp eq ptr %4, null, !dbg !420
  ret i1 %5, !dbg !421
}

; Function Attrs: noinline nounwind optnone
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !422 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !425, metadata !DIExpression()), !dbg !426
  %3 = load ptr, ptr %2, align 4, !dbg !427
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !428
  %5 = load ptr, ptr %4, align 4, !dbg !428
  ret ptr %5, !dbg !429
}
...
!404 = distinct !DISubprogram(name: "z_arm_nmi", scope: !405, file: !405, line: 56, type: !406, scopeLine: 57, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !216)
!405 = !DIFile(filename: "arch/arm/core/nmi.c", directory: "/home/sri/zephyrproject/zephyr")
!406 = !DISubroutineType(types: !407)
!407 = !{null}
!408 = !DILocation(line: 58, column: 2, scope: !404)
!409 = !DILocation(line: 59, column: 2, scope: !404)
!410 = !DILocation(line: 60, column: 1, scope: !404)
!411 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !338, file: !338, line: 335, type: !412, scopeLine: 335, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!412 = !DISubroutineType(types: !413)
!413 = !{!414, !415}
!414 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!415 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !337, size: 32)
!416 = !DILocalVariable(name: "list", arg: 1, scope: !411, file: !338, line: 335, type: !415)
!417 = !DILocation(line: 335, column: 55, scope: !411)
!418 = !DILocation(line: 335, column: 92, scope: !411)
!419 = !DILocation(line: 335, column: 71, scope: !411)
!420 = !DILocation(line: 335, column: 98, scope: !411)
!421 = !DILocation(line: 335, column: 63, scope: !411)
!422 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !338, file: !338, line: 255, type: !423, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !216)
!423 = !DISubroutineType(types: !424)
!424 = !{!342, !415}
!425 = !DILocalVariable(name: "list", arg: 1, scope: !422, file: !338, line: 255, type: !415)
!426 = !DILocation(line: 255, column: 64, scope: !422)
!427 = !DILocation(line: 257, column: 9, scope: !422)
!428 = !DILocation(line: 257, column: 15, scope: !422)
!429 = !DILocation(line: 257, column: 2, scope: !422)
