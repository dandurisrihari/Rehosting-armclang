...
define internal i64 @z_impl_k_thread_timeout_expires_ticks(ptr noundef %0) #0 !dbg !272 {
  ...
  %6 = call i64 @z_timeout_expires(ptr noundef %5) #5, !dbg !285
  ret i64 %6, !dbg !286
}
...
define internal i64 @z_impl_k_thread_timeout_remaining_ticks(ptr noundef %0) #0 !dbg !287 {
  ...
  %6 = call i64 @z_timeout_remaining(ptr noundef %5) #5, !dbg !294
  ret i64 %6, !dbg !295
}
...
define internal i64 @z_impl_k_timer_expires_ticks(ptr noundef %0) #0 !dbg !296 {
  ...
  %5 = call i64 @z_timeout_expires(ptr noundef %4) #5, !dbg !323
  ret i64 %5, !dbg !324
}
...
define internal i64 @z_impl_k_timer_remaining_ticks(ptr noundef %0) #0 !dbg !325 {
  ...
  %5 = call i64 @z_timeout_remaining(ptr noundef %4) #5, !dbg !331
  ret i64 %5, !dbg !332
}
...
define internal i32 @z_impl_k_queue_is_empty(ptr noundef %0) #0 !dbg !355 {
  ...
  %5 = call zeroext i1 @sys_sflist_is_empty(ptr noundef %4) #5, !dbg !381
...
define hidden void @z_impl_k_thread_abort(ptr noundef %0) #1 !dbg !433 {
  %2 = alloca i32, align 4
  %3 = alloca ptr, align 4
  store ptr %0, ptr %3, align 4
  call void @llvm.dbg.declare(metadata ptr %3, metadata !439, metadata !DIExpression()), !dbg !440
  %4 = load ptr, ptr getelementptr inbounds (%struct._cpu, ptr @_kernel, i32 0, i32 2), align 4, !dbg !441
  %5 = load ptr, ptr %3, align 4, !dbg !443
  %6 = icmp eq ptr %4, %5, !dbg !444
  br i1 %6, label %7, label %19, !dbg !445

7:                                                ; preds = %1
  call void @llvm.lifetime.start.p0(i64 4, ptr %2) #6, !dbg !446
  call void @llvm.dbg.declare(metadata ptr %2, metadata !452, metadata !DIExpression()), !dbg !462
  %8 = call i32 asm sideeffect "MRS $0, ipsr", "=r"() #6, !dbg !463, !srcloc !464
  store i32 %8, ptr %2, align 4, !dbg !463
  %9 = load i32, ptr %2, align 4, !dbg !465
  call void @llvm.lifetime.end.p0(i64 4, ptr %2) #6, !dbg !466
  %10 = icmp ne i32 %9, 0, !dbg !467
  %11 = zext i1 %10 to i64, !dbg !467
  %12 = select i1 %10, i32 1, i32 0, !dbg !467
  br i1 %10, label %13, label %18, !dbg !468

13:                                               ; preds = %7
  %14 = load volatile i32, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 1), align 4, !dbg !469
  %15 = or i32 %14, 268435456, !dbg !469
  store volatile i32 %15, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 1), align 4, !dbg !469
  %16 = load volatile i32, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 8), align 4, !dbg !471
  %17 = and i32 %16, -32769, !dbg !471
  store volatile i32 %17, ptr getelementptr inbounds (%struct.SCB_Type, ptr inttoptr (i32 -536810240 to ptr), i32 0, i32 8), align 4, !dbg !471
  br label %18, !dbg !472
...
19:                                               ; preds = %18, %1
  %20 = load ptr, ptr %3, align 4, !dbg !474
  call void @z_thread_abort(ptr noundef %20) #5, !dbg !475
  ret void, !dbg !476
}
...
declare !dbg !477 dso_local void @z_thread_abort(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !481 dso_local i64 @z_timeout_expires(ptr noundef) #3

; Function Attrs: optsize
declare !dbg !486 dso_local i64 @z_timeout_remaining(ptr noundef) #3

; Function Attrs: inlinehint nounwind optsize
define internal zeroext i1 @sys_sflist_is_empty(ptr noundef %0) #0 !dbg !487 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !492, metadata !DIExpression()), !dbg !493
  %3 = load ptr, ptr %2, align 4, !dbg !494
  %4 = call ptr @sys_sflist_peek_head(ptr noundef %3) #5, !dbg !495
  %5 = icmp eq ptr %4, null, !dbg !496
  ret i1 %5, !dbg !497
}

; Function Attrs: inlinehint nounwind optsize
define internal ptr @sys_sflist_peek_head(ptr noundef %0) #0 !dbg !498 {
  %2 = alloca ptr, align 4
  store ptr %0, ptr %2, align 4
  call void @llvm.dbg.declare(metadata ptr %2, metadata !502, metadata !DIExpression()), !dbg !503
  %3 = load ptr, ptr %2, align 4, !dbg !504
  %4 = getelementptr inbounds %struct._sflist, ptr %3, i32 0, i32 0, !dbg !505
  %5 = load ptr, ptr %4, align 4, !dbg !505
  ret ptr %5, !dbg !506
}
...
!433 = distinct !DISubprogram(name: "z_impl_k_thread_abort", scope: !434, file: !434, line: 26, type: !435, scopeLine: 27, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !438)
!434 = !DIFile(filename: "arch/arm/core/cortex_m/thread_abort.c", directory: "/home/sri/zephyrproject/zephyr")
!435 = !DISubroutineType(types: !436)
!436 = !{null, !437}
!437 = !DIDerivedType(tag: DW_TAG_typedef, name: "k_tid_t", file: !125, line: 359, baseType: !123)
!438 = !{!439}
!439 = !DILocalVariable(name: "thread", arg: 1, scope: !433, file: !434, line: 26, type: !437)
!440 = !DILocation(line: 26, column: 36, scope: !433)
!441 = !DILocation(line: 28, column: 22, scope: !442)
!442 = distinct !DILexicalBlock(scope: !433, file: !434, line: 28, column: 6)
!443 = !DILocation(line: 28, column: 33, scope: !442)
!444 = !DILocation(line: 28, column: 30, scope: !442)
!445 = !DILocation(line: 28, column: 6, scope: !433)
!446 = !DILocation(line: 820, column: 3, scope: !447, inlinedAt: !453)
!447 = distinct !DISubprogram(name: "__get_IPSR", scope: !448, file: !448, line: 818, type: !449, scopeLine: 819, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !451)
!448 = !DIFile(filename: "modules/hal/cmsis/CMSIS/Core/Include/cmsis_armclang.h", directory: "/home/sri/zephyrproject")
!449 = !DISubroutineType(types: !450)
!450 = !{!95}
!451 = !{!452}
!452 = !DILocalVariable(name: "result", scope: !447, file: !448, line: 820, type: !95)
!453 = distinct !DILocation(line: 48, column: 10, scope: !454, inlinedAt: !459)
!454 = distinct !DISubprogram(name: "arch_is_in_isr", scope: !455, file: !455, line: 46, type: !456, scopeLine: 47, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !231)
!455 = !DIFile(filename: "arch/arm/include/cortex_m/exc.h", directory: "/home/sri/zephyrproject/zephyr")
!456 = !DISubroutineType(types: !457)
!457 = !{!458}
!458 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!459 = distinct !DILocation(line: 29, column: 7, scope: !460)
!460 = distinct !DILexicalBlock(scope: !461, file: !434, line: 29, column: 7)
!461 = distinct !DILexicalBlock(scope: !442, file: !434, line: 28, column: 41)
!462 = !DILocation(line: 820, column: 12, scope: !447, inlinedAt: !453)
!463 = !DILocation(line: 822, column: 3, scope: !447, inlinedAt: !453)
!464 = !{i64 168344}
!465 = !DILocation(line: 823, column: 10, scope: !447, inlinedAt: !453)
!466 = !DILocation(line: 824, column: 1, scope: !447, inlinedAt: !453)
!467 = !DILocation(line: 48, column: 9, scope: !454, inlinedAt: !459)
!468 = !DILocation(line: 29, column: 7, scope: !461)
!469 = !DILocation(line: 41, column: 54, scope: !470)
!470 = distinct !DILexicalBlock(scope: !460, file: !434, line: 29, column: 25)
!471 = !DILocation(line: 47, column: 55, scope: !470)
!472 = !DILocation(line: 48, column: 3, scope: !470)
!473 = !DILocation(line: 49, column: 2, scope: !461)
!474 = !DILocation(line: 51, column: 17, scope: !433)
!475 = !DILocation(line: 51, column: 2, scope: !433)
!476 = !DILocation(line: 52, column: 1, scope: !433)
!477 = !DISubprogram(name: "z_thread_abort", scope: !478, file: !478, line: 68, type: !479, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !231)
!478 = !DIFile(filename: "kernel/include/ksched.h", directory: "/home/sri/zephyrproject/zephyr")
!479 = !DISubroutineType(types: !480)
!480 = !{null, !123}
!481 = !DISubprogram(name: "z_timeout_expires", scope: !214, file: !214, line: 642, type: !482, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !231)
!482 = !DISubroutineType(types: !483)
!483 = !{!275, !484}
!484 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !485, size: 32)
!485 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !183)
!486 = !DISubprogram(name: "z_timeout_remaining", scope: !214, file: !214, line: 643, type: !482, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !231)
!487 = distinct !DISubprogram(name: "sys_sflist_is_empty", scope: !363, file: !363, line: 335, type: !488, scopeLine: 335, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !491)
!488 = !DISubroutineType(types: !489)
!489 = !{!458, !490}
!490 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !362, size: 32)
!491 = !{!492}
!492 = !DILocalVariable(name: "list", arg: 1, scope: !487, file: !363, line: 335, type: !490)
!493 = !DILocation(line: 335, column: 55, scope: !487)
!494 = !DILocation(line: 335, column: 92, scope: !487)
!495 = !DILocation(line: 335, column: 71, scope: !487)
!496 = !DILocation(line: 335, column: 98, scope: !487)
!497 = !DILocation(line: 335, column: 63, scope: !487)
!498 = distinct !DISubprogram(name: "sys_sflist_peek_head", scope: !363, file: !363, line: 255, type: !499, scopeLine: 256, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !501)
!499 = !DISubroutineType(types: !500)
!500 = !{!367, !490}
!501 = !{!502}
!502 = !DILocalVariable(name: "list", arg: 1, scope: !498, file: !363, line: 255, type: !490)
!503 = !DILocation(line: 255, column: 64, scope: !498)
!504 = !DILocation(line: 257, column: 9, scope: !498)
!505 = !DILocation(line: 257, column: 15, scope: !498)
!506 = !DILocation(line: 257, column: 2, scope: !498)
